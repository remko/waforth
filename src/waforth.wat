...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xb2 funcref)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20470) "\5c\04\02\00" "\08" "CONSTANT   " "\57\00\00\00")
  (elem (i32.const 0x57) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20484) "\70\04\02\00" "\05" "COUNT  " "\58\00\00\00")
  (elem (i32.const 0x58) $COUNT)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x204a0) "\94\04\02\00" "\06" "CREATE " "\5a\00\00\00")
  (elem (i32.const 0x5a) $CREATE)
  ...
  (func $DECIMAL (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x204b0) "\a0\04\02\00" "\07" "DECIMAL" "\5b\00\00\00")
  (elem (i32.const 0x5b) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204c0) "\b0\04\02\00" "\05" "DEPTH  " "\5c\00\00\00")
  (elem (i32.const 0x5c) $DEPTH)
  ...
  (data (i32.const 0x204d0) "\c0\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\5d\00\00\00")
  (elem (i32.const 0x5d) $DO)
  ...
  (data (i32.const 0x204dc) "\d0\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\5e\00\00\00")
  (elem (i32.const 0x5e) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204ec) "\dc\04\02\00" "\04" "DROP   " "\5f\00\00\00")
  (elem (i32.const 0x5f) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204fc) "\ec\04\02\00" "\03" "DUP" "\60\00\00\00")
  (elem (i32.const 0x60) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x20508) "\fc\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\61\00\00\00")
  (elem (i32.const 0x61) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20518) "\08\05\02\00" "\04" "EMIT   " "\62\00\00\00")
  (elem (i32.const 0x62) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x20528) "\18\05\02\00" "\0c" "ENVIRONMENT?   " "\63\00\00\00")
  (elem (i32.const 0x63) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x20540) "\28\05\02\00" "\05" "ERASE  " "\64\00\00\00")
  (elem (i32.const 0x64) $ERASE)
  ...
  (data (i32.const 0x20550) "\40\05\02\00" "\08" "EVALUATE   " "\65\00\00\00")
  (elem (i32.const 0x65) $EVALUATE)
  ...
  (data (i32.const 0x20564) "\50\05\02\00" "\07" "EXECUTE" "\66\00\00\00")
  (elem (i32.const 0x66) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20574) "\64\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\67\00\00\00")
  (elem (i32.const 0x67) $EXIT)
  ...
  (data (i32.const 0x20584) "\74\05\02\00" "\05" "FALSE  " "\68\00\00\00")
  (elem (i32.const 0x68) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20594) "\84\05\02\00" "\04" "FILL   " "\69\00\00\00")
  (elem (i32.const 0x69) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205a4) "\94\05\02\00" "\04" "FIND   " "\6a\00\00\00")
  (elem (i32.const 0x6a) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x205b4) "\a4\05\02\00" "\06" "FM/MOD " "\6b\00\00\00")
  (elem (i32.const 0x6b) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205c4) "\b4\05\02\00" "\04" "HERE   " "\6c\00\00\00")
  (elem (i32.const 0x6c) $HERE)
  ...
  (func $HEX (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205d4) "\c4\05\02\00" "\03" "HEX" "\6d\00\00\00")
  (elem (i32.const 0x6d) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x205e0) "\d4\05\02\00" "\04" "HOLD   " "\6e\00\00\00")
  (elem (i32.const 0x6e) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205f0) "\e0\05\02\00" "\01" "I  " "\6f\00\00\00")
  (elem (i32.const 0x6f) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205fc) "\f0\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\70\00\00\00")
  (elem (i32.const 0x70) $IF)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2061c) "\08\06\02\00" "\06" "INVERT " "\72\00\00\00")
  (elem (i32.const 0x72) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2062c) "\1c\06\02\00" "\01" "J  " "\73\00\00\00")
  (elem (i32.const 0x73) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20638) "\2c\06\02\00" "\03" "KEY" "\74\00\00\00")
  (elem (i32.const 0x74) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20644) "\38\06\02\00" "\06" "LATEST " "\75\00\00\00")
  (elem (i32.const 0x75) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20654) "\44\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\76\00\00\00")
  (elem (i32.const 0x76) $LEAVE)
  ...
  (data (i32.const 0x20664) "\54\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\77\00\00\00")
  (elem (i32.const 0x77) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20674) "\64\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\78\00\00\00")
  (elem (i32.const 0x78) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20684) "\74\06\02\00" "\06" "LSHIFT " "\79\00\00\00")
  (elem (i32.const 0x79) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20694) "\84\06\02\00" "\02" "M* " "\7a\00\00\00")
  (elem (i32.const 0x7a) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x206a0) "\94\06\02\00" "\03" "MAX" "\7b\00\00\00")
  (elem (i32.const 0x7b) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x206ac) "\a0\06\02\00" "\03" "MIN" "\7c\00\00\00")
  (elem (i32.const 0x7c) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x206b8) "\ac\06\02\00" "\03" "MOD" "\7d\00\00\00")
  (elem (i32.const 0x7d) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x206c4) "\b8\06\02\00" "\04" "MOVE   " "\7e\00\00\00")
  (elem (i32.const 0x7e) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206d4) "\c4\06\02\00" "\06" "NEGATE " "\7f\00\00\00")
  (elem (i32.const 0x7f) $NEGATE)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x206f0) "\e4\06\02\00" "\02" "OR " "\81\00\00\00")
  (elem (i32.const 0x81) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206fc) "\f0\06\02\00" "\04" "OVER   " "\82\00\00\00")
  (elem (i32.const 0x82) $OVER)
  ...
  (data (i32.const 0x2070c) "\fc\06\02\00" "\03" "PAD" "\83\00\00\00")
  (elem (i32.const 0x83) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x20718) "\0c\07\02\00" "\05" "PARSE  " "\84\00\00\00")
  (elem (i32.const 0x84) $PARSE)
  ...
  (data (i32.const 0x20728) "\18\07\02\00" "\0a" "PARSE-NAME " "\85\00\00\00")
  (elem (i32.const 0x85) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2073c) "\28\07\02\00" "\04" "PICK   " "\86\00\00\00")
  (elem (i32.const 0x86) $PICK)
  ...
  (data (i32.const 0x20760) "\4c\07\02\00" "\04" "QUIT   " "\88\00\00\00")
  (elem (i32.const 0x88) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20770) "\60\07\02\00" "\02" "R> " "\89\00\00\00")
  ...
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2077c) "\70\07\02\00" "\02" "R@ " "\8a\00\00\00")
  (elem (i32.const 0x8a) $R@)
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20788) "\7c\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\8b\00\00\00")
  (elem (i32.const 0x8b) $RECURSE)
  ...
  (data (i32.const 0x20798) "\88\07\02\00" "\06" "REFILL " "\8c\00\00\00")
  (elem (i32.const 0x8c) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x207a8) "\98\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\8d\00\00\00")
  (elem (i32.const 0x8d) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x207b8) "\a8\07\02\00" "\03" "ROT" "\8e\00\00\00")
  (elem (i32.const 0x8e) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x207c4) "\b8\07\02\00" "\06" "RSHIFT " "\8f\00\00\00")
  (elem (i32.const 0x8f) $RSHIFT)
  ...
  (data (i32.const 0x207d4) "\c4\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\90\00\00\00")
  (elem (i32.const 0x90) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207e0) "\d4\07\02\00" "\03" "S>D" "\91\00\00\00")
  (elem (i32.const 0x91) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x207ec) "\e0\07\02\00" "\05" "SCALL  " "\92\00\00\00")
  (elem (i32.const 0x92) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207fc) "\ec\07\02\00" "\04" "SIGN   " "\93\00\00\00")
  (elem (i32.const 0x93) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x2080c) "\fc\07\02\00" "\06" "SM/REM " "\94\00\00\00")
  (elem (i32.const 0x94) $SM/REM)
  ...
  (data (i32.const 0x2081c) "\0c\08\02\00" "\06" "SOURCE " "\95\00\00\00")
  (elem (i32.const 0x95) $SOURCE)
  ...
  (data (i32.const 0x2082c) "\1c\08\02\00" "\09" "SOURCE-ID  " "\96\00\00\00")
  (elem (i32.const 0x96) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x20840) "\2c\08\02\00" "\05" "SPACE  " "\97\00\00\00")
  (elem (i32.const 0x97) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x20850) "\40\08\02\00" "\06" "SPACES " "\98\00\00\00")
  (elem (i32.const 0x98) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x20860) "\50\08\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20874) "\60\08\02\00" "\04" "SWAP   " "\99\00\00\00")
  (elem (i32.const 0x99) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20884) "\74\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\9a\00\00\00")
  (elem (i32.const 0x9a) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20894) "\84\08\02\00" "\02" "TO " "\9b\00\00\00")
  (elem (i32.const 0x9b) $TO)
  ...
  (data (i32.const 0x208a0) "\94\08\02\00" "\04" "TRUE   " "\9c\00\00\00")
  (elem (i32.const 0x9c) $TRUE)
  ...
  (data (i32.const 0x208c0) "\b0\08\02\00" "\04" "TYPE   " "\9e\00\00\00")
  (elem (i32.const 0x9e) $TYPE)
  ...
  (func $U. (param $tos i32) (result i32)
    ...
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x208d0) "\c0\08\02\00" "\02" "U. " "\9f\00\00\00")
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208dc) "\d0\08\02\00" "\02" "U< " "\a0\00\00\00")
  (elem (i32.const 0xa0) $U<)
  ...
  (func $U> (param $tos i32) (result i32)
    ...
    (if (i32.gt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208e8) "\dc\08\02\00" "\02" "U> " "\a1\00\00\00")
  (elem (i32.const 0xa1) $U>)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x208f4) "\e8\08\02\00" "\03" "UM*" "\a2\00\00\00")
  (elem (i32.const 0xa2) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20900) "\f4\08\02\00" "\06" "UM/MOD " "\a3\00\00\00")
  (elem (i32.const 0xa3) $UM/MOD)
  ...
  (data (i32.const 0x20910) "\00\09\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\a4\00\00\00")
  (elem (i32.const 0xa4) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x20920) "\10\09\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\a5\00\00\00")
  (elem (i32.const 0xa5) $UNTIL)
  ...
  (data (i32.const 0x20930) "\20\09\02\00" "\06" "UNUSED " "\a6\00\00\00")
  (elem (i32.const 0xa6) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x20940) "\30\09\02\00" "\05" "VALUE  " "\57\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20950) "\40\09\02\00" "\08" "VARIABLE   " "\a7\00\00\00")
  (elem (i32.const 0xa7) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x20964) "\50\09\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a8\00\00\00")
  (elem (i32.const 0xa8) $WHILE)
    ...
    (i32.store (local.tee $bbbtos (i32.sub (local.get $tos) (i32.const 12)))
      (if (result i32) (i32.lt_u
        ...
        (else
          (i32.const 0))))
    (local.get $bbtos))
  (data (i32.const 0x20974) "\64\09\02\00" "\06" "WITHIN " "\a9\00\00\00")
  (elem (i32.const 0xa9) $WITHIN)
  ...
  (data (i32.const 0x20984) "\74\09\02\00" "\04" "WORD   " "\aa\00\00\00")
  (elem (i32.const 0xaa) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20994) "\84\09\02\00" "\05" "WORDS  " "\ab\00\00\00")
  (elem (i32.const 0xab) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x209a4) "\94\09\02\00" "\03" "XOR" "\ac\00\00\00")
  (elem (i32.const 0xac) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x20870 (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x209b0) "\a4\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\ad\00\00\00")
  (elem (i32.const 0xad) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x209bc) "\b0\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\ae\00\00\00")
  (elem (i32.const 0xae) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x209c8) "\bc\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\af\00\00\00")
  (elem (i32.const 0xaf) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x209d8) "\c8\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\b0\00\00\00")
  (elem (i32.const 0xb0) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x20870 (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x209e4) "\d8\09\02\00" "\01" "]  " "\b1\00\00\00")
  (elem (i32.const 0xb1) $right-bracket)
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then 
            ...
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              ...
              (then 
                (local.set $number)
                (if (i32.load (i32.const 0x20870 (; = body(STATE) ;)))
                  (then
          ...
          (else 
            ...
            (if (i32.and
                  (i32.load (i32.const 0x20870 (; = body(STATE) ;)))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x209e4))
  (global $here (mut i32) (i32.const 0x209f0))
  (global $nextTableIndex (mut i32) (i32.const 0xb2))
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x20870 (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
