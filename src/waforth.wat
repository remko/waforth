...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xac funcref)
  ...
  (func $# (param $tos i32) (result i32)
    ...
    (local $m i64)
    (local $npo i32)
    (local.set $base (i64.extend_i32_u (i32.load (i32.const 0x20394 (; = body(BASE) ;)))))
  ...
  (func $. (param $tos i32) (result i32)
    ...
    (call $U._ (local.get $v) (i32.load (i32.const 0x20394 (; = body(BASE) ;))))
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9a (; = index("TYPE") ;))))
  ...
  (func $.S (param $tos i32) (result i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (call $U._ (i32.load (local.get $p)) (i32.load (i32.const 0x20394 (; = body(BASE) ;))))
        (call $shell_emit (i32.const 0x20))
  ...
  (func $2R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x20250) "\40\02\02\00" "\03" "2R>" "\33\00\00\00")
  (elem (i32.const 0x33) $2R>)
  ...
  (func $2SWAP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 4))
                (local.get $x2))
    (local.get $tos))
  (data (i32.const 0x2025c) "\50\02\02\00" "\05" "2SWAP  " "\34\00\00\00")
  (elem (i32.const 0x34) $2SWAP)
  ...
  (func $: (param $tos i32) (result i32)
    ...
    (call $right-bracket))
  (data (i32.const 0x2026c) "\5c\02\02\00" "\01" ":  " "\35\00\00\00")
  (elem (i32.const 0x35) $:)
  ...
  (func $semicolon (param $tos i32) (result i32)
    ...
    (call $hidden)
    (call $left-bracket))
  (data (i32.const 0x20278) "\6c\02\02\00" "\81" (; F_IMMEDIATE ;) ";  " "\36\00\00\00")
  (elem (i32.const 0x36) $semicolon)
  ...
  (func $<# (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20290) "\84\02\02\00" "\02" "<# " "\38\00\00\00")
  (elem (i32.const 0x38) $<#)
  ...
  (func $>BODY (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202b4) "\a8\02\02\00" "\05" ">BODY  " "\3b\00\00\00")
  (elem (i32.const 0x3b) $>BODY)

  ;; [6.1.0560](https://forth-standard.org/standard/core/toIN)
  (data (i32.const 0x202c4) "\b4\02\02\00" "\43" (; F_DATA ;) ">IN" "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00")
  ...
  (func $>NUMBER (param $tos i32) (result i32) 
    ...
    (local.get $tos))
  (data (i32.const 0x202d4) "\c4\02\02\00" "\07" ">NUMBER" "\3c\00\00\00")
  (elem (i32.const 0x3c) $>NUMBER)
  ...
  (data (i32.const 0x202e4) "\d4\02\02\00" "\02" ">R " "\3d\00\00\00")
  (elem (i32.const 0x3d) $>R)
  ...
  (func $?DUP (param $tos i32) (result i32)
    ...
    (if (result i32) (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else 
        (local.get $tos))))
  (data (i32.const 0x202f0) "\e4\02\02\00" "\04" "?DUP   " "\3e\00\00\00")
  (elem (i32.const 0x3e) $?DUP)
  ...
  (func $@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20300) "\f0\02\02\00" "\01" "@  " "\3f\00\00\00")
  (elem (i32.const 0x3f) $@)
  ...
  (data (i32.const 0x2030c) "\00\03\02\00" "\05" "ABORT  " "\40\00\00\00")
  (elem (i32.const 0x40) $ABORT)
  ...
  (func $ABORTq (param $tos i32) (result i32)
    ...
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9a (; = index("TYPE") ;)))
    (call $emitICall (i32.const 0) (i32.const 0x40 (; = index("ABORT") ;)))
    (call $compileThen))
  (data (i32.const 0x2031c) "\0c\03\02\00" "\86" (; F_IMMEDIATE ;) "ABORT\22 " "\41\00\00\00")
  (elem (i32.const 0x41) $ABORTq)
  ...
  (func $ABS (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))
                (i32.sub (i32.xor (local.tee $v (i32.load (local.get $btos)))
                        ...
                        (local.get $y)))
    (local.get $tos))
  (data (i32.const 0x2032c) "\1c\03\02\00" "\03" "ABS" "\42\00\00\00")
  (elem (i32.const 0x42) $ABS)
  ...
  (func $ACCEPT (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20338) "\2c\03\02\00" "\06" "ACCEPT " "\43\00\00\00")
  (elem (i32.const 0x43) $ACCEPT)
  ...
  (func $ALIGN (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20348) "\38\03\02\00" "\05" "ALIGN  " "\44\00\00\00")
  (elem (i32.const 0x44) $ALIGN)
  ...
  (func $ALIGNED (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20358) "\48\03\02\00" "\07" "ALIGNED" "\45\00\00\00")
  (elem (i32.const 0x45) $ALIGNED)
  ...
  (data (i32.const 0x20368) "\58\03\02\00" "\05" "ALLOT  " "\46\00\00\00")
  (elem (i32.const 0x46) $ALLOT)
  ...
  (func $AND (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.and (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20378) "\68\03\02\00" "\03" "AND" "\47\00\00\00")
  (elem (i32.const 0x47) $AND)

  ;; [6.1.0750](https://forth-standard.org/standard/core/BASE)
  (data (i32.const 0x20384) "\78\03\02\00" "\44" (; F_DATA ;) "BASE   " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\0a\00\00\00" (; = pack(10) ;))
  ...
  (func $BEGIN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileBegin))
  (data (i32.const 0x20398) "\84\03\02\00" "\85" (; F_IMMEDIATE ;) "BEGIN  " "\48\00\00\00")
  (elem (i32.const 0x48) $BEGIN)

  ;; [6.1.0770](https://forth-standard.org/standard/core/BL)
  (func $BL (param $tos i32) (result i32)
    (call $push (local.get $tos) (i32.const 32)))
  (data (i32.const 0x203a8) "\98\03\02\00" "\02" "BL " "\49\00\00\00")
  (elem (i32.const 0x49) $BL)
  ...
  (data (i32.const 0x203cc) "\c0\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\4c\00\00\00")
  (elem (i32.const 0x4c) $Cq)
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203e4) "\d8\03\02\00" "\05" "CELL+  " "\4e\00\00\00")
  (elem (i32.const 0x4e) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203f4) "\e4\03\02\00" "\05" "CELLS  " "\4f\00\00\00")
  (elem (i32.const 0x4f) $CELLS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20434) "\24\04\02\00" "\08" "CONSTANT   " "\53\00\00\00")
  (elem (i32.const 0x53) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20448) "\34\04\02\00" "\05" "COUNT  " "\54\00\00\00")
  (elem (i32.const 0x54) $COUNT)
  ...
  (data (i32.const 0x20458) "\48\04\02\00" "\02" "CR " "\55\00\00\00")
  (elem (i32.const 0x55) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20464) "\58\04\02\00" "\06" "CREATE " "\56\00\00\00")
  (elem (i32.const 0x56) $CREATE)

  ;; [6.1.1170](https://forth-standard.org/standard/core/DECIMAL)
  (func $DECIMAL (param $tos i32) (result i32)
    (i32.store (i32.const 0x20394 (; = body(BASE) ;)) (i32.const 10))
    (local.get $tos))
  (data (i32.const 0x20474) "\64\04\02\00" "\07" "DECIMAL" "\57\00\00\00")
  (elem (i32.const 0x57) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20484) "\74\04\02\00" "\05" "DEPTH  " "\58\00\00\00")
  (elem (i32.const 0x58) $DEPTH)
  ...
  (data (i32.const 0x20494) "\84\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\59\00\00\00")
  (elem (i32.const 0x59) $DO)
  ...
  (data (i32.const 0x204a0) "\94\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\5a\00\00\00")
  (elem (i32.const 0x5a) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204b0) "\a0\04\02\00" "\04" "DROP   " "\5b\00\00\00")
  (elem (i32.const 0x5b) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204c0) "\b0\04\02\00" "\03" "DUP" "\5c\00\00\00")
  (elem (i32.const 0x5c) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204cc) "\c0\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\5d\00\00\00")
  (elem (i32.const 0x5d) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204dc) "\cc\04\02\00" "\04" "EMIT   " "\5e\00\00\00")
  (elem (i32.const 0x5e) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x204ec) "\dc\04\02\00" "\0c" "ENVIRONMENT?   " "\5f\00\00\00")
  (elem (i32.const 0x5f) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x20504) "\ec\04\02\00" "\05" "ERASE  " "\60\00\00\00")
  (elem (i32.const 0x60) $ERASE)
  ...
  (func $EVALUATE (param $tos i32) (result i32)
    ...
    (local.set $prevIn (i32.load (i32.const 0x202d0 (; = body(>IN) ;))))
    ...
    (i32.store (i32.const 0x202d0 (; = body(>IN) ;)) (i32.const 0))

    (call $interpret (local.get $bbtos))

    ;; Restore input state
    (global.set $sourceID (local.get $prevSourceID))
    (i32.store (i32.const 0x202d0 (; = body(>IN) ;)) (local.get $prevIn))
    (global.set $inputBufferBase (local.get $prevInputBufferBase))
    (global.set $inputBufferSize (local.get $prevInputBufferSize)))
  (data (i32.const 0x20514) "\04\05\02\00" "\08" "EVALUATE   " "\61\00\00\00")
  (elem (i32.const 0x61) $EVALUATE)
  ...
  (data (i32.const 0x20528) "\14\05\02\00" "\07" "EXECUTE" "\62\00\00\00")
  (elem (i32.const 0x62) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20538) "\28\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\63\00\00\00")
  (elem (i32.const 0x63) $EXIT)
  ...
  (data (i32.const 0x20548) "\38\05\02\00" "\05" "FALSE  " "\64\00\00\00")
  (elem (i32.const 0x64) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20558) "\48\05\02\00" "\04" "FILL   " "\65\00\00\00")
  (elem (i32.const 0x65) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20568) "\58\05\02\00" "\04" "FIND   " "\66\00\00\00")
  (elem (i32.const 0x66) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20578) "\68\05\02\00" "\06" "FM/MOD " "\67\00\00\00")
  (elem (i32.const 0x67) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20588) "\78\05\02\00" "\04" "HERE   " "\68\00\00\00")
  (elem (i32.const 0x68) $HERE)

  ;; [6.2.1660](https://forth-standard.org/standard/core/HEX)
  (func $HEX (param $tos i32) (result i32)
    (i32.store (i32.const 0x20394 (; = body(BASE) ;)) (i32.const 16))
    (local.get $tos))
  (data (i32.const 0x20598) "\88\05\02\00" "\03" "HEX" "\69\00\00\00")
  (elem (i32.const 0x69) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x205a4) "\98\05\02\00" "\04" "HOLD   " "\6a\00\00\00")
  (elem (i32.const 0x6a) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205b4) "\a4\05\02\00" "\01" "I  " "\6b\00\00\00")
  (elem (i32.const 0x6b) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205c0) "\b4\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\6c\00\00\00")
  (elem (i32.const 0x6c) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205cc) "\c0\05\02\00" "\09" "IMMEDIATE  " "\6d\00\00\00")
  (elem (i32.const 0x6d) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205e0) "\cc\05\02\00" "\06" "INVERT " "\6e\00\00\00")
  (elem (i32.const 0x6e) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205f0) "\e0\05\02\00" "\01" "J  " "\6f\00\00\00")
  (elem (i32.const 0x6f) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205fc) "\f0\05\02\00" "\03" "KEY" "\70\00\00\00")
  (elem (i32.const 0x70) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20608) "\fc\05\02\00" "\06" "LATEST " "\71\00\00\00")
  (elem (i32.const 0x71) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20618) "\08\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\72\00\00\00")
  (elem (i32.const 0x72) $LEAVE)
  ...
  (data (i32.const 0x20628) "\18\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\73\00\00\00")
  (elem (i32.const 0x73) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20638) "\28\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\74\00\00\00")
  (elem (i32.const 0x74) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20648) "\38\06\02\00" "\06" "LSHIFT " "\75\00\00\00")
  (elem (i32.const 0x75) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20658) "\48\06\02\00" "\02" "M* " "\76\00\00\00")
  (elem (i32.const 0x76) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20664) "\58\06\02\00" "\03" "MAX" "\77\00\00\00")
  (elem (i32.const 0x77) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x20670) "\64\06\02\00" "\03" "MIN" "\78\00\00\00")
  (elem (i32.const 0x78) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x2067c) "\70\06\02\00" "\03" "MOD" "\79\00\00\00")
  (elem (i32.const 0x79) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x20688) "\7c\06\02\00" "\04" "MOVE   " "\7a\00\00\00")
  (elem (i32.const 0x7a) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20698) "\88\06\02\00" "\06" "NEGATE " "\7b\00\00\00")
  (elem (i32.const 0x7b) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x206a8) "\98\06\02\00" "\03" "NIP" "\7c\00\00\00")
  (elem (i32.const 0x7c) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x206b4) "\a8\06\02\00" "\02" "OR " "\7d\00\00\00")
  (elem (i32.const 0x7d) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206c0) "\b4\06\02\00" "\04" "OVER   " "\7e\00\00\00")
  (elem (i32.const 0x7e) $OVER)
  ...
  (data (i32.const 0x206d0) "\c0\06\02\00" "\03" "PAD" "\7f\00\00\00")
  (elem (i32.const 0x7f) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x206dc) "\d0\06\02\00" "\05" "PARSE  " "\80\00\00\00")
  (elem (i32.const 0x80) $PARSE)
  ...
  (data (i32.const 0x206ec) "\dc\06\02\00" "\0a" "PARSE-NAME " "\81\00\00\00")
  (elem (i32.const 0x81) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20700) "\ec\06\02\00" "\04" "PICK   " "\82\00\00\00")
  (elem (i32.const 0x82) $PICK)
  ...
  (data (i32.const 0x20710) "\00\07\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\83\00\00\00")
  (elem (i32.const 0x83) $POSTPONE)
  ...
  (data (i32.const 0x20724) "\10\07\02\00" "\04" "QUIT   " "\84\00\00\00")
  (elem (i32.const 0x84) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20734) "\24\07\02\00" "\02" "R> " "\85\00\00\00")
  ...
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20740) "\34\07\02\00" "\02" "R@ " "\86\00\00\00")
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x2074c) "\40\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\87\00\00\00")
  (elem (i32.const 0x87) $RECURSE)
  ...
  (data (i32.const 0x2075c) "\4c\07\02\00" "\06" "REFILL " "\88\00\00\00")
  (elem (i32.const 0x88) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x2076c) "\5c\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\89\00\00\00")
  (elem (i32.const 0x89) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2077c) "\6c\07\02\00" "\03" "ROT" "\8a\00\00\00")
  (elem (i32.const 0x8a) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20788) "\7c\07\02\00" "\06" "RSHIFT " "\8b\00\00\00")
  (elem (i32.const 0x8b) $RSHIFT)
  ...
  (data (i32.const 0x20798) "\88\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\8c\00\00\00")
  (elem (i32.const 0x8c) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207a4) "\98\07\02\00" "\03" "S>D" "\8d\00\00\00")
  (elem (i32.const 0x8d) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x207b0) "\a4\07\02\00" "\05" "SCALL  " "\8e\00\00\00")
  (elem (i32.const 0x8e) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207c0) "\b0\07\02\00" "\04" "SIGN   " "\8f\00\00\00")
  (elem (i32.const 0x8f) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207d0) "\c0\07\02\00" "\06" "SM/REM " "\90\00\00\00")
  (elem (i32.const 0x90) $SM/REM)
  ...
  (data (i32.const 0x207e0) "\d0\07\02\00" "\06" "SOURCE " "\91\00\00\00")
  (elem (i32.const 0x91) $SOURCE)
  ...
  (data (i32.const 0x207f0) "\e0\07\02\00" "\09" "SOURCE-ID  " "\92\00\00\00")
  (elem (i32.const 0x92) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x20804) "\f0\07\02\00" "\05" "SPACE  " "\93\00\00\00")
  (elem (i32.const 0x93) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x20814) "\04\08\02\00" "\06" "SPACES " "\94\00\00\00")
  (elem (i32.const 0x94) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x20824) "\14\08\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20838) "\24\08\02\00" "\04" "SWAP   " "\95\00\00\00")
  (elem (i32.const 0x95) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20848) "\38\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\96\00\00\00")
  (elem (i32.const 0x96) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20858) "\48\08\02\00" "\02" "TO " "\97\00\00\00")
  (elem (i32.const 0x97) $TO)
  ...
  (data (i32.const 0x20864) "\58\08\02\00" "\04" "TRUE   " "\98\00\00\00")
  (elem (i32.const 0x98) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x20874) "\64\08\02\00" "\04" "TUCK   " "\99\00\00\00")
  (elem (i32.const 0x99) $TUCK)
  ...
  (data (i32.const 0x20884) "\74\08\02\00" "\04" "TYPE   " "\9a\00\00\00")
  (elem (i32.const 0x9a) $TYPE)

  ;; [6.1.2320](https://forth-standard.org/standard/core/Ud)
  (func $U. (param $tos i32) (result i32)
    (local.get $tos)
    (call $U._ (call $pop) (i32.load (i32.const 0x20394 (; = body(BASE) ;))))
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x20894) "\84\08\02\00" "\02" "U. " "\9b\00\00\00")
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208a0) "\94\08\02\00" "\02" "U< " "\9c\00\00\00")
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x208ac) "\a0\08\02\00" "\03" "UM*" "\9d\00\00\00")
  (elem (i32.const 0x9d) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x208b8) "\ac\08\02\00" "\06" "UM/MOD " "\9e\00\00\00")
  (elem (i32.const 0x9e) $UM/MOD)
  ...
  (data (i32.const 0x208c8) "\b8\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\9f\00\00\00")
  (elem (i32.const 0x9f) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x208d8) "\c8\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\a0\00\00\00")
  (elem (i32.const 0xa0) $UNTIL)
  ...
  (data (i32.const 0x208e8) "\d8\08\02\00" "\06" "UNUSED " "\a1\00\00\00")
  (elem (i32.const 0xa1) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x208f8) "\e8\08\02\00" "\05" "VALUE  " "\53\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20908) "\f8\08\02\00" "\08" "VARIABLE   " "\a2\00\00\00")
  (elem (i32.const 0xa2) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x2091c) "\08\09\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a3\00\00\00")
  (elem (i32.const 0xa3) $WHILE)
  ...
  (data (i32.const 0x2092c) "\1c\09\02\00" "\04" "WORD   " "\a4\00\00\00")
  (elem (i32.const 0xa4) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2093c) "\2c\09\02\00" "\05" "WORDS  " "\a5\00\00\00")
  (elem (i32.const 0xa5) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x2094c) "\3c\09\02\00" "\03" "XOR" "\a6\00\00\00")
  (elem (i32.const 0xa6) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x20834 (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20958) "\4c\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\a7\00\00\00")
  (elem (i32.const 0xa7) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20964) "\58\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\a8\00\00\00")
  (elem (i32.const 0xa8) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20970) "\64\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\a9\00\00\00")
  (elem (i32.const 0xa9) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x20980) "\70\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\aa\00\00\00")
  (elem (i32.const 0xaa) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x20834 (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x2098c) "\80\09\02\00" "\01" "]  " "\ab\00\00\00")
  (elem (i32.const 0xab) $right-bracket)
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then 
            ...
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              ...
              (then 
                (local.set $number)
                (if (i32.load (i32.const 0x20834 (; = body(STATE) ;)))
                  (then
          ...
          (else 
            ...
            (if (i32.and
                  (i32.load (i32.const 0x20834 (; = body(STATE) ;)))
  ...
  (func $number (param $value i64) (param $addr i32) (param $length i32) (result i64 i32 i32)
    ...
    (local.set $base (i32.load (i32.const 0x20394 (; = body(BASE) ;))))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x2098c))
  (global $here (mut i32) (i32.const 0x20998))
  (global $nextTableIndex (mut i32) (i32.const 0xac))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x20834 (; = body(STATE) ;))))
  ...
  (func $parse (param $delim i32) (result i32 i32)
    ...
    (local.set $p 
      ...
      (i32.load (i32.const 0x202d0 (; = body(>IN) ;))))))
    ...
    (i32.store (i32.const 0x202d0 (; = body(>IN) ;)) 
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x20834 (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
