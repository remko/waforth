...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xae funcref)
  ...
  (func $# (param $tos i32) (result i32)
    ...
    (local $m i64)
    (local $npo i32)
    (local.set $base (i64.extend_i32_u (i32.load (i32.const 0x203ac (; = body(BASE) ;)))))
  ...
  (func $. (param $tos i32) (result i32)
    ...
    (call $U._ (local.get $v) (i32.load (i32.const 0x203ac (; = body(BASE) ;))))
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9c (; = index("TYPE") ;))))
  ...
  (func $.S (param $tos i32) (result i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (call $U._ (i32.load (local.get $p)) (i32.load (i32.const 0x203ac (; = body(BASE) ;))))
        (call $shell_emit (i32.const 0x20))
  ...
  (func $0<> (param $tos i32) (result i32)
    ...
    (if (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else (i32.store (local.get $btos) (i32.const 0))))
    (local.get $tos))
  (data (i32.const 0x201b4) "\a8\01\02\00" "\03" "0<>" "\27\00\00\00")
  ...
  (func $0> (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) 
      ...
      (else (i32.store (local.get $btos) (i32.const 0))))
    (local.get $tos))
  (data (i32.const 0x201cc) "\c0\01\02\00" "\02" "0> " "\29\00\00\00")
  ...
  (func $1- (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x201e4) "\d8\01\02\00" "\02" "1- " "\2b\00\00\00")
  ...
  (func $2@  (param $tos i32) (result i32)
    ...
    (call $SWAP)
    (call $@))
  (data (i32.const 0x20214) "\08\02\02\00" "\02" "2@ " "\2f\00\00\00")
  ...
  (func $2>R (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20220) "\14\02\02\00" "\03" "2>R" "\30\00\00\00")
  (elem (i32.const 0x30) $2>R)
  ...
  (data (i32.const 0x2022c) "\20\02\02\00" "\05" "2DROP  " "\31\00\00\00")
  (elem (i32.const 0x31) $2DROP)
  ...
  (data (i32.const 0x2023c) "\2c\02\02\00" "\04" "2DUP   " "\32\00\00\00")
  (elem (i32.const 0x32) $2DUP)
  ...
  (func $2OVER (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x2024c) "\3c\02\02\00" "\05" "2OVER  " "\33\00\00\00")
  (elem (i32.const 0x33) $2OVER)
  ...
  (func $2R@ (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x2025c) "\4c\02\02\00" "\03" "2R@" "\34\00\00\00")
  (elem (i32.const 0x34) $2R@)
  ...
  (func $2R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x20268) "\5c\02\02\00" "\03" "2R>" "\35\00\00\00")
  ...
  (func $2SWAP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 4))
                (local.get $x2))
    (local.get $tos))
  (data (i32.const 0x20274) "\68\02\02\00" "\05" "2SWAP  " "\36\00\00\00")
  (elem (i32.const 0x36) $2SWAP)
  ...
  (func $: (param $tos i32) (result i32)
    ...
    (call $right-bracket))
  (data (i32.const 0x20284) "\74\02\02\00" "\01" ":  " "\37\00\00\00")
  (elem (i32.const 0x37) $:)
  ...
  (func $semicolon (param $tos i32) (result i32)
    ...
    (call $hidden)
    (call $left-bracket))
  (data (i32.const 0x20290) "\84\02\02\00" "\81" (; F_IMMEDIATE ;) ";  " "\38\00\00\00")
  (elem (i32.const 0x38) $semicolon)
  ...
  (func $<# (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202a8) "\9c\02\02\00" "\02" "<# " "\3a\00\00\00")
  (elem (i32.const 0x3a) $<#)
  ...
  (func $= (param $tos i32) (result i32)
    ...
    (if (i32.eq (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x202b4) "\a8\02\02\00" "\01" "=  " "\3b\00\00\00")
  (elem (i32.const 0x3b) $=)
  ...
  (func $> (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x202c0) "\b4\02\02\00" "\01" ">  " "\3c\00\00\00")
  (elem (i32.const 0x3c) $>)
  ...
  (func $>BODY (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202cc) "\c0\02\02\00" "\05" ">BODY  " "\3d\00\00\00")
  (elem (i32.const 0x3d) $>BODY)

  ;; [6.1.0560](https://forth-standard.org/standard/core/toIN)
  (data (i32.const 0x202dc) "\cc\02\02\00" "\43" (; F_DATA ;) ">IN" "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00")
  ...
  (func $>NUMBER (param $tos i32) (result i32) 
    ...
    (local.get $tos))
  (data (i32.const 0x202ec) "\dc\02\02\00" "\07" ">NUMBER" "\3e\00\00\00")
  (elem (i32.const 0x3e) $>NUMBER)
  ...
  (data (i32.const 0x202fc) "\ec\02\02\00" "\02" ">R " "\3f\00\00\00")
  (elem (i32.const 0x3f) $>R)
  ...
  (func $?DUP (param $tos i32) (result i32)
    ...
    (if (result i32) (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else 
        (local.get $tos))))
  (data (i32.const 0x20308) "\fc\02\02\00" "\04" "?DUP   " "\40\00\00\00")
  (elem (i32.const 0x40) $?DUP)
  ...
  (func $@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20318) "\08\03\02\00" "\01" "@  " "\41\00\00\00")
  (elem (i32.const 0x41) $@)
  ...
  (data (i32.const 0x20324) "\18\03\02\00" "\05" "ABORT  " "\42\00\00\00")
  (elem (i32.const 0x42) $ABORT)
  ...
  (func $ABORTq (param $tos i32) (result i32)
    ...
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9c (; = index("TYPE") ;)))
    (call $emitICall (i32.const 0) (i32.const 0x42 (; = index("ABORT") ;)))
    (call $compileThen))
  (data (i32.const 0x20334) "\24\03\02\00" "\86" (; F_IMMEDIATE ;) "ABORT\22 " "\43\00\00\00")
  (elem (i32.const 0x43) $ABORTq)
  ...
  (func $ABS (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))
                (i32.sub (i32.xor (local.tee $v (i32.load (local.get $btos)))
                        ...
                        (local.get $y)))
    (local.get $tos))
  (data (i32.const 0x20344) "\34\03\02\00" "\03" "ABS" "\44\00\00\00")
  (elem (i32.const 0x44) $ABS)
  ...
  (func $ACCEPT (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20350) "\44\03\02\00" "\06" "ACCEPT " "\45\00\00\00")
  (elem (i32.const 0x45) $ACCEPT)
  ...
  (func $ALIGN (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20360) "\50\03\02\00" "\05" "ALIGN  " "\46\00\00\00")
  (elem (i32.const 0x46) $ALIGN)
  ...
  (func $ALIGNED (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20370) "\60\03\02\00" "\07" "ALIGNED" "\47\00\00\00")
  (elem (i32.const 0x47) $ALIGNED)
  ...
  (data (i32.const 0x20380) "\70\03\02\00" "\05" "ALLOT  " "\48\00\00\00")
  (elem (i32.const 0x48) $ALLOT)
  ...
  (func $AND (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.and (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20390) "\80\03\02\00" "\03" "AND" "\49\00\00\00")
  (elem (i32.const 0x49) $AND)

  ;; [6.1.0750](https://forth-standard.org/standard/core/BASE)
  (data (i32.const 0x2039c) "\90\03\02\00" "\44" (; F_DATA ;) "BASE   " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\0a\00\00\00" (; = pack(10) ;))
  ...
  (func $BEGIN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileBegin))
  (data (i32.const 0x203b0) "\9c\03\02\00" "\85" (; F_IMMEDIATE ;) "BEGIN  " "\4a\00\00\00")
  (elem (i32.const 0x4a) $BEGIN)

  ;; [6.1.0770](https://forth-standard.org/standard/core/BL)
  (func $BL (param $tos i32) (result i32)
    (call $push (local.get $tos) (i32.const 32)))
  (data (i32.const 0x203c0) "\b0\03\02\00" "\02" "BL " "\4b\00\00\00")
  (elem (i32.const 0x4b) $BL)
  ...
  (func $Cc (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x203d8) "\cc\03\02\00" "\02" "C, " "\4d\00\00\00")
  (elem (i32.const 0x4d) $Cc)
  ...
  (data (i32.const 0x203e4) "\d8\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\4e\00\00\00")
  (elem (i32.const 0x4e) $Cq)
  ...
  (func $C@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203f0) "\e4\03\02\00" "\02" "C@ " "\4f\00\00\00")
  (elem (i32.const 0x4f) $C@)
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203fc) "\f0\03\02\00" "\05" "CELL+  " "\50\00\00\00")
  (elem (i32.const 0x50) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2040c) "\fc\03\02\00" "\05" "CELLS  " "\51\00\00\00")
  (elem (i32.const 0x51) $CELLS)
  ...
  (func $CHAR (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2041c) "\0c\04\02\00" "\04" "CHAR   " "\52\00\00\00")
  (elem (i32.const 0x52) $CHAR)

  ;; [6.1.0897](https://forth-standard.org/standard/core/CHARPlus)
  (func $CHAR+ (param $tos i32) (result i32)
    (call $1+ (local.get $tos)))
  (data (i32.const 0x2042c) "\1c\04\02\00" "\05" "CHAR+  " "\53\00\00\00")
  (elem (i32.const 0x53) $CHAR+)

  ;; [6.1.0898](https://forth-standard.org/standard/core/CHARS)
  (func $CHARS (param $tos i32) (result i32)
    (local.get $tos))
  (data (i32.const 0x2043c) "\2c\04\02\00" "\05" "CHARS  " "\54\00\00\00")
  (elem (i32.const 0x54) $CHARS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x2044c) "\3c\04\02\00" "\08" "CONSTANT   " "\55\00\00\00")
  (elem (i32.const 0x55) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20460) "\4c\04\02\00" "\05" "COUNT  " "\56\00\00\00")
  (elem (i32.const 0x56) $COUNT)
  ...
  (data (i32.const 0x20470) "\60\04\02\00" "\02" "CR " "\57\00\00\00")
  (elem (i32.const 0x57) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2047c) "\70\04\02\00" "\06" "CREATE " "\58\00\00\00")
  (elem (i32.const 0x58) $CREATE)

  ;; [6.1.1170](https://forth-standard.org/standard/core/DECIMAL)
  (func $DECIMAL (param $tos i32) (result i32)
    (i32.store (i32.const 0x203ac (; = body(BASE) ;)) (i32.const 10))
    (local.get $tos))
  (data (i32.const 0x2048c) "\7c\04\02\00" "\07" "DECIMAL" "\59\00\00\00")
  (elem (i32.const 0x59) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2049c) "\8c\04\02\00" "\05" "DEPTH  " "\5a\00\00\00")
  (elem (i32.const 0x5a) $DEPTH)
  ...
  (data (i32.const 0x204ac) "\9c\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\5b\00\00\00")
  (elem (i32.const 0x5b) $DO)
  ...
  (data (i32.const 0x204b8) "\ac\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\5c\00\00\00")
  (elem (i32.const 0x5c) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204c8) "\b8\04\02\00" "\04" "DROP   " "\5d\00\00\00")
  (elem (i32.const 0x5d) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204d8) "\c8\04\02\00" "\03" "DUP" "\5e\00\00\00")
  (elem (i32.const 0x5e) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204e4) "\d8\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\5f\00\00\00")
  (elem (i32.const 0x5f) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204f4) "\e4\04\02\00" "\04" "EMIT   " "\60\00\00\00")
  (elem (i32.const 0x60) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x20504) "\f4\04\02\00" "\0c" "ENVIRONMENT?   " "\61\00\00\00")
  (elem (i32.const 0x61) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x2051c) "\04\05\02\00" "\05" "ERASE  " "\62\00\00\00")
  (elem (i32.const 0x62) $ERASE)
  ...
  (func $EVALUATE (param $tos i32) (result i32)
    ...
    (local.set $prevIn (i32.load (i32.const 0x202e8 (; = body(>IN) ;))))
    ...
    (i32.store (i32.const 0x202e8 (; = body(>IN) ;)) (i32.const 0))

    (call $interpret (local.get $bbtos))

    ;; Restore input state
    (global.set $sourceID (local.get $prevSourceID))
    (i32.store (i32.const 0x202e8 (; = body(>IN) ;)) (local.get $prevIn))
    (global.set $inputBufferBase (local.get $prevInputBufferBase))
    (global.set $inputBufferSize (local.get $prevInputBufferSize)))
  (data (i32.const 0x2052c) "\1c\05\02\00" "\08" "EVALUATE   " "\63\00\00\00")
  (elem (i32.const 0x63) $EVALUATE)
  ...
  (data (i32.const 0x20540) "\2c\05\02\00" "\07" "EXECUTE" "\64\00\00\00")
  (elem (i32.const 0x64) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20550) "\40\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\65\00\00\00")
  (elem (i32.const 0x65) $EXIT)
  ...
  (data (i32.const 0x20560) "\50\05\02\00" "\05" "FALSE  " "\66\00\00\00")
  (elem (i32.const 0x66) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20570) "\60\05\02\00" "\04" "FILL   " "\67\00\00\00")
  (elem (i32.const 0x67) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20580) "\70\05\02\00" "\04" "FIND   " "\68\00\00\00")
  (elem (i32.const 0x68) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20590) "\80\05\02\00" "\06" "FM/MOD " "\69\00\00\00")
  (elem (i32.const 0x69) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205a0) "\90\05\02\00" "\04" "HERE   " "\6a\00\00\00")
  (elem (i32.const 0x6a) $HERE)

  ;; [6.2.1660](https://forth-standard.org/standard/core/HEX)
  (func $HEX (param $tos i32) (result i32)
    (i32.store (i32.const 0x203ac (; = body(BASE) ;)) (i32.const 16))
    (local.get $tos))
  (data (i32.const 0x205b0) "\a0\05\02\00" "\03" "HEX" "\6b\00\00\00")
  (elem (i32.const 0x6b) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x205bc) "\b0\05\02\00" "\04" "HOLD   " "\6c\00\00\00")
  (elem (i32.const 0x6c) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205cc) "\bc\05\02\00" "\01" "I  " "\6d\00\00\00")
  (elem (i32.const 0x6d) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205d8) "\cc\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\6e\00\00\00")
  (elem (i32.const 0x6e) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205e4) "\d8\05\02\00" "\09" "IMMEDIATE  " "\6f\00\00\00")
  (elem (i32.const 0x6f) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205f8) "\e4\05\02\00" "\06" "INVERT " "\70\00\00\00")
  (elem (i32.const 0x70) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20608) "\f8\05\02\00" "\01" "J  " "\71\00\00\00")
  (elem (i32.const 0x71) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20614) "\08\06\02\00" "\03" "KEY" "\72\00\00\00")
  (elem (i32.const 0x72) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20620) "\14\06\02\00" "\06" "LATEST " "\73\00\00\00")
  (elem (i32.const 0x73) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20630) "\20\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\74\00\00\00")
  (elem (i32.const 0x74) $LEAVE)
  ...
  (data (i32.const 0x20640) "\30\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\75\00\00\00")
  (elem (i32.const 0x75) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20650) "\40\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\76\00\00\00")
  (elem (i32.const 0x76) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20660) "\50\06\02\00" "\06" "LSHIFT " "\77\00\00\00")
  (elem (i32.const 0x77) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20670) "\60\06\02\00" "\02" "M* " "\78\00\00\00")
  (elem (i32.const 0x78) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x2067c) "\70\06\02\00" "\03" "MAX" "\79\00\00\00")
  (elem (i32.const 0x79) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x20688) "\7c\06\02\00" "\03" "MIN" "\7a\00\00\00")
  (elem (i32.const 0x7a) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20694) "\88\06\02\00" "\03" "MOD" "\7b\00\00\00")
  (elem (i32.const 0x7b) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x206a0) "\94\06\02\00" "\04" "MOVE   " "\7c\00\00\00")
  (elem (i32.const 0x7c) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206b0) "\a0\06\02\00" "\06" "NEGATE " "\7d\00\00\00")
  (elem (i32.const 0x7d) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x206c0) "\b0\06\02\00" "\03" "NIP" "\7e\00\00\00")
  (elem (i32.const 0x7e) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x206cc) "\c0\06\02\00" "\02" "OR " "\7f\00\00\00")
  (elem (i32.const 0x7f) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206d8) "\cc\06\02\00" "\04" "OVER   " "\80\00\00\00")
  (elem (i32.const 0x80) $OVER)
  ...
  (data (i32.const 0x206e8) "\d8\06\02\00" "\03" "PAD" "\81\00\00\00")
  (elem (i32.const 0x81) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x206f4) "\e8\06\02\00" "\05" "PARSE  " "\82\00\00\00")
  (elem (i32.const 0x82) $PARSE)
  ...
  (data (i32.const 0x20704) "\f4\06\02\00" "\0a" "PARSE-NAME " "\83\00\00\00")
  (elem (i32.const 0x83) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20718) "\04\07\02\00" "\04" "PICK   " "\84\00\00\00")
  (elem (i32.const 0x84) $PICK)
  ...
  (data (i32.const 0x20728) "\18\07\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\85\00\00\00")
  (elem (i32.const 0x85) $POSTPONE)
  ...
  (data (i32.const 0x2073c) "\28\07\02\00" "\04" "QUIT   " "\86\00\00\00")
  (elem (i32.const 0x86) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2074c) "\3c\07\02\00" "\02" "R> " "\87\00\00\00")
  (elem (i32.const 0x87) $R>)

  ;; [6.1.2070](https://forth-standard.org/standard/core/RFetch)
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20758) "\4c\07\02\00" "\02" "R@ " "\88\00\00\00")
  (elem (i32.const 0x88) $R@)
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20764) "\58\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\89\00\00\00")
  (elem (i32.const 0x89) $RECURSE)
  ...
  (data (i32.const 0x20774) "\64\07\02\00" "\06" "REFILL " "\8a\00\00\00")
  (elem (i32.const 0x8a) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x20784) "\74\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\8b\00\00\00")
  (elem (i32.const 0x8b) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20794) "\84\07\02\00" "\03" "ROT" "\8c\00\00\00")
  (elem (i32.const 0x8c) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x207a0) "\94\07\02\00" "\06" "RSHIFT " "\8d\00\00\00")
  (elem (i32.const 0x8d) $RSHIFT)
  ...
  (data (i32.const 0x207b0) "\a0\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\8e\00\00\00")
  (elem (i32.const 0x8e) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207bc) "\b0\07\02\00" "\03" "S>D" "\8f\00\00\00")
  (elem (i32.const 0x8f) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x207c8) "\bc\07\02\00" "\05" "SCALL  " "\90\00\00\00")
  (elem (i32.const 0x90) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207d8) "\c8\07\02\00" "\04" "SIGN   " "\91\00\00\00")
  (elem (i32.const 0x91) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207e8) "\d8\07\02\00" "\06" "SM/REM " "\92\00\00\00")
  (elem (i32.const 0x92) $SM/REM)
  ...
  (data (i32.const 0x207f8) "\e8\07\02\00" "\06" "SOURCE " "\93\00\00\00")
  (elem (i32.const 0x93) $SOURCE)
  ...
  (data (i32.const 0x20808) "\f8\07\02\00" "\09" "SOURCE-ID  " "\94\00\00\00")
  (elem (i32.const 0x94) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x2081c) "\08\08\02\00" "\05" "SPACE  " "\95\00\00\00")
  (elem (i32.const 0x95) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x2082c) "\1c\08\02\00" "\06" "SPACES " "\96\00\00\00")
  (elem (i32.const 0x96) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x2083c) "\2c\08\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20850) "\3c\08\02\00" "\04" "SWAP   " "\97\00\00\00")
  (elem (i32.const 0x97) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20860) "\50\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\98\00\00\00")
  (elem (i32.const 0x98) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20870) "\60\08\02\00" "\02" "TO " "\99\00\00\00")
  (elem (i32.const 0x99) $TO)
  ...
  (data (i32.const 0x2087c) "\70\08\02\00" "\04" "TRUE   " "\9a\00\00\00")
  (elem (i32.const 0x9a) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x2088c) "\7c\08\02\00" "\04" "TUCK   " "\9b\00\00\00")
  (elem (i32.const 0x9b) $TUCK)
  ...
  (data (i32.const 0x2089c) "\8c\08\02\00" "\04" "TYPE   " "\9c\00\00\00")
  (elem (i32.const 0x9c) $TYPE)

  ;; [6.1.2320](https://forth-standard.org/standard/core/Ud)
  (func $U. (param $tos i32) (result i32)
    (local.get $tos)
    (call $U._ (call $pop) (i32.load (i32.const 0x203ac (; = body(BASE) ;))))
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x208ac) "\9c\08\02\00" "\02" "U. " "\9d\00\00\00")
  (elem (i32.const 0x9d) $U.)
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208b8) "\ac\08\02\00" "\02" "U< " "\9e\00\00\00")
  (elem (i32.const 0x9e) $U<)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x208c4) "\b8\08\02\00" "\03" "UM*" "\9f\00\00\00")
  (elem (i32.const 0x9f) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x208d0) "\c4\08\02\00" "\06" "UM/MOD " "\a0\00\00\00")
  (elem (i32.const 0xa0) $UM/MOD)
  ...
  (data (i32.const 0x208e0) "\d0\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\a1\00\00\00")
  (elem (i32.const 0xa1) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x208f0) "\e0\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\a2\00\00\00")
  (elem (i32.const 0xa2) $UNTIL)
  ...
  (data (i32.const 0x20900) "\f0\08\02\00" "\06" "UNUSED " "\a3\00\00\00")
  (elem (i32.const 0xa3) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x20910) "\00\09\02\00" "\05" "VALUE  " "\55\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20920) "\10\09\02\00" "\08" "VARIABLE   " "\a4\00\00\00")
  (elem (i32.const 0xa4) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x20934) "\20\09\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a5\00\00\00")
  (elem (i32.const 0xa5) $WHILE)
  ...
  (data (i32.const 0x20944) "\34\09\02\00" "\04" "WORD   " "\a6\00\00\00")
  (elem (i32.const 0xa6) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20954) "\44\09\02\00" "\05" "WORDS  " "\a7\00\00\00")
  (elem (i32.const 0xa7) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20964) "\54\09\02\00" "\03" "XOR" "\a8\00\00\00")
  (elem (i32.const 0xa8) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x2084c (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20970) "\64\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\a9\00\00\00")
  (elem (i32.const 0xa9) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x2097c) "\70\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\aa\00\00\00")
  (elem (i32.const 0xaa) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20988) "\7c\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\ab\00\00\00")
  (elem (i32.const 0xab) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x20998) "\88\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\ac\00\00\00")
  (elem (i32.const 0xac) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x2084c (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x209a4) "\98\09\02\00" "\01" "]  " "\ad\00\00\00")
  (elem (i32.const 0xad) $right-bracket)
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then 
            ...
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              ...
              (then 
                (local.set $number)
                (if (i32.load (i32.const 0x2084c (; = body(STATE) ;)))
                  (then
          ...
          (else 
            ...
            (if (i32.and
                  (i32.load (i32.const 0x2084c (; = body(STATE) ;)))
  ...
  (func $number (param $value i64) (param $addr i32) (param $length i32) (result i64 i32 i32)
    ...
    (local.set $base (i32.load (i32.const 0x203ac (; = body(BASE) ;))))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x209a4))
  (global $here (mut i32) (i32.const 0x209b0))
  (global $nextTableIndex (mut i32) (i32.const 0xae))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x2084c (; = body(STATE) ;))))
  ...
  (func $parse (param $delim i32) (result i32 i32)
    ...
    (local.set $p 
      ...
      (i32.load (i32.const 0x202e8 (; = body(>IN) ;))))))
    ...
    (i32.store (i32.const 0x202e8 (; = body(>IN) ;)) 
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x2084c (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
