...
(module $WAForth
  ...
  (func $C! (param $tos i32) (result i32)
    ...
    (i32.store8 (i32.load (i32.sub (local.get $tos) (i32.const 4)))
                (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))))
    (local.get $bbtos))
  (data (i32.const 0x20400) "\f0\03\02\00" "\02" "C! " "\4f\00\00\00")
  ...
  (data (i32.const 0x20418) "\0c\04\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\51\00\00\00")
  (elem (i32.const 0x51) $Cq)
  ...
  (func $C@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20424) "\18\04\02\00" "\02" "C@ " "\52\00\00\00")
  (elem (i32.const 0x52) $C@)
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20430) "\24\04\02\00" "\05" "CELL+  " "\53\00\00\00")
  (elem (i32.const 0x53) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20440) "\30\04\02\00" "\05" "CELLS  " "\54\00\00\00")
  (elem (i32.const 0x54) $CELLS)
  ...
  (data (i32.const 0x20480) "\70\04\02\00" "\08" "COMPILE,   " "\58\00\00\00")
  (elem (i32.const 0x58) $COMPILEComma)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20494) "\80\04\02\00" "\08" "CONSTANT   " "\59\00\00\00")
  (elem (i32.const 0x59) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204a8) "\94\04\02\00" "\05" "COUNT  " "\5a\00\00\00")
  (elem (i32.const 0x5a) $COUNT)

  ;; [6.1.0990](https://forth-standard.org/standard/core/CR)
  (func $CR (param $tos i32) (result i32)
    (call $shell_emit (i32.const 0x0a))
    (local.get $tos))
  (data (i32.const 0x204b8) "\a8\04\02\00" "\02" "CR " "\5b\00\00\00")
  (elem (i32.const 0x5b) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x204c4) "\b8\04\02\00" "\06" "CREATE " "\5c\00\00\00")
  (elem (i32.const 0x5c) $CREATE)
  ...
  (func $DECIMAL (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x204d4) "\c4\04\02\00" "\07" "DECIMAL" "\5d\00\00\00")
  (elem (i32.const 0x5d) $DECIMAL)
  ...
  (func $DEFER (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4)))
    (local.get $tos))
  (data (i32.const 0x204e4) "\d4\04\02\00" "\05" "DEFER  " "\5e\00\00\00")
  (elem (i32.const 0x5e) $DEFER)
  ...
  (func $DEFER! (param $tos i32) (result i32)
    ...
    (i32.store
      ...
      (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))))
    (local.get $bbtos))
  (data (i32.const 0x204f4) "\e4\04\02\00" "\06" "DEFER! " "\5f\00\00\00")
    ...
    (i32.store
      ...
      (i32.load
        (i32.add
          ...
          (i32.const 4))))
    (local.get $tos))
  (data (i32.const 0x20504) "\f4\04\02\00" "\06" "DEFER@ " "\60\00\00\00")
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20514) "\04\05\02\00" "\05" "DEPTH  " "\61\00\00\00")
  (elem (i32.const 0x61) $DEPTH)
  ...
  (data (i32.const 0x20524) "\14\05\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\62\00\00\00")
  (elem (i32.const 0x62) $DO)
  ...
  (data (i32.const 0x20530) "\24\05\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\63\00\00\00")
  (elem (i32.const 0x63) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20540) "\30\05\02\00" "\04" "DROP   " "\64\00\00\00")
  (elem (i32.const 0x64) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20550) "\40\05\02\00" "\03" "DUP" "\65\00\00\00")
  (elem (i32.const 0x65) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x2055c) "\50\05\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\66\00\00\00")
  (elem (i32.const 0x66) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2056c) "\5c\05\02\00" "\04" "EMIT   " "\67\00\00\00")
  (elem (i32.const 0x67) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x2057c) "\6c\05\02\00" "\0c" "ENVIRONMENT?   " "\68\00\00\00")
  (elem (i32.const 0x68) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x20594) "\7c\05\02\00" "\05" "ERASE  " "\69\00\00\00")
  (elem (i32.const 0x69) $ERASE)
  ...
  (data (i32.const 0x205a4) "\94\05\02\00" "\08" "EVALUATE   " "\6a\00\00\00")
  (elem (i32.const 0x6a) $EVALUATE)
  ...
  (data (i32.const 0x205b8) "\a4\05\02\00" "\07" "EXECUTE" "\6b\00\00\00")
  (elem (i32.const 0x6b) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x205c8) "\b8\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\6c\00\00\00")
  (elem (i32.const 0x6c) $EXIT)
  ...
  (data (i32.const 0x205d8) "\c8\05\02\00" "\05" "FALSE  " "\6d\00\00\00")
  (elem (i32.const 0x6d) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x205e8) "\d8\05\02\00" "\04" "FILL   " "\6e\00\00\00")
  (elem (i32.const 0x6e) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205f8) "\e8\05\02\00" "\04" "FIND   " "\6f\00\00\00")
  (elem (i32.const 0x6f) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20608) "\f8\05\02\00" "\06" "FM/MOD " "\70\00\00\00")
  (elem (i32.const 0x70) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20618) "\08\06\02\00" "\04" "HERE   " "\71\00\00\00")
  (elem (i32.const 0x71) $HERE)
  ...
  (func $HEX (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20628) "\18\06\02\00" "\03" "HEX" "\72\00\00\00")
  (elem (i32.const 0x72) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x20634) "\28\06\02\00" "\04" "HOLD   " "\73\00\00\00")
  (elem (i32.const 0x73) $HOLD)
  ...
  (func $HOLDS (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (i32.sub (local.get $tos) (i32.const 8)))
  (data (i32.const 0x20644) "\34\06\02\00" "\05" "HOLDS  " "\74\00\00\00")
  (elem (i32.const 0x74) $HOLDS)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20654) "\44\06\02\00" "\01" "I  " "\75\00\00\00")
  (elem (i32.const 0x75) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x20660) "\54\06\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\76\00\00\00")
  (elem (i32.const 0x76) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2066c) "\60\06\02\00" "\09" "IMMEDIATE  " "\77\00\00\00")
  (elem (i32.const 0x77) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20680) "\6c\06\02\00" "\06" "INVERT " "\78\00\00\00")
  (elem (i32.const 0x78) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2069c) "\90\06\02\00" "\01" "J  " "\7a\00\00\00")
  (elem (i32.const 0x7a) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206a8) "\9c\06\02\00" "\03" "KEY" "\7b\00\00\00")
  (elem (i32.const 0x7b) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206b4) "\a8\06\02\00" "\06" "LATEST " "\7c\00\00\00")
  (elem (i32.const 0x7c) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x206c4) "\b4\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\7d\00\00\00")
  (elem (i32.const 0x7d) $LEAVE)
  ...
  (data (i32.const 0x206d4) "\c4\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\7e\00\00\00")
  (elem (i32.const 0x7e) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x206e4) "\d4\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\7f\00\00\00")
  (elem (i32.const 0x7f) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x206f4) "\e4\06\02\00" "\06" "LSHIFT " "\80\00\00\00")
  (elem (i32.const 0x80) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20704) "\f4\06\02\00" "\02" "M* " "\81\00\00\00")
  (elem (i32.const 0x81) $M*)
  ...
  (func $MARKER (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20710) "\04\07\02\00" "\06" "MARKER " "\82\00\00\00")
  (elem (i32.const 0x82) $MARKER)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20720) "\10\07\02\00" "\03" "MAX" "\83\00\00\00")
  (elem (i32.const 0x83) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x2072c) "\20\07\02\00" "\03" "MIN" "\84\00\00\00")
  (elem (i32.const 0x84) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20738) "\2c\07\02\00" "\03" "MOD" "\85\00\00\00")
  (elem (i32.const 0x85) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x20744) "\38\07\02\00" "\04" "MOVE   " "\86\00\00\00")
  (elem (i32.const 0x86) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20754) "\44\07\02\00" "\06" "NEGATE " "\87\00\00\00")
  (elem (i32.const 0x87) $NEGATE)
  ...
  (func $NIP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 8))
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20764) "\54\07\02\00" "\03" "NIP" "\88\00\00\00")
  (elem (i32.const 0x88) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20770) "\64\07\02\00" "\02" "OR " "\89\00\00\00")
  (elem (i32.const 0x89) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2077c) "\70\07\02\00" "\04" "OVER   " "\8a\00\00\00")
  (elem (i32.const 0x8a) $OVER)
  ...
  (data (i32.const 0x2078c) "\7c\07\02\00" "\03" "PAD" "\8b\00\00\00")
  (elem (i32.const 0x8b) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x20798) "\8c\07\02\00" "\05" "PARSE  " "\8c\00\00\00")
  (elem (i32.const 0x8c) $PARSE)
  ...
  (data (i32.const 0x207a8) "\98\07\02\00" "\0a" "PARSE-NAME " "\8d\00\00\00")
  (elem (i32.const 0x8d) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x207bc) "\a8\07\02\00" "\04" "PICK   " "\8e\00\00\00")
  (elem (i32.const 0x8e) $PICK)
  ...
  (data (i32.const 0x207cc) "\bc\07\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\8f\00\00\00")
  (elem (i32.const 0x8f) $POSTPONE)
  ...
  (data (i32.const 0x207e0) "\cc\07\02\00" "\04" "QUIT   " "\90\00\00\00")
  (elem (i32.const 0x90) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207f0) "\e0\07\02\00" "\02" "R> " "\91\00\00\00")
  (elem (i32.const 0x91) $R>)

  ;; [6.1.2070](https://forth-standard.org/standard/core/RFetch)
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207fc) "\f0\07\02\00" "\02" "R@ " "\92\00\00\00")
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20808) "\fc\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\93\00\00\00")
  (elem (i32.const 0x93) $RECURSE)
  ...
  (data (i32.const 0x20818) "\08\08\02\00" "\06" "REFILL " "\94\00\00\00")
  (elem (i32.const 0x94) $REFILL)
