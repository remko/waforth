...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xad funcref)
  ...
  (func $# (param $tos i32) (result i32)
    ...
    (local $m i64)
    (local $npo i32)
    (local.set $base (i64.extend_i32_u (i32.load (i32.const 0x203a0 (; = body(BASE) ;)))))
  ...
  (func $. (param $tos i32) (result i32)
    ...
    (call $U._ (local.get $v) (i32.load (i32.const 0x203a0 (; = body(BASE) ;))))
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9b (; = index("TYPE") ;))))
  ...
  (func $.S (param $tos i32) (result i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (call $U._ (i32.load (local.get $p)) (i32.load (i32.const 0x203a0 (; = body(BASE) ;))))
        (call $shell_emit (i32.const 0x20))
  ...
  (func $2SWAP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 4))
                (local.get $x2))
    (local.get $tos))
  (data (i32.const 0x20268) "\5c\02\02\00" "\05" "2SWAP  " "\35\00\00\00")
  (elem (i32.const 0x35) $2SWAP)
  ...
  (func $: (param $tos i32) (result i32)
    ...
    (call $right-bracket))
  (data (i32.const 0x20278) "\68\02\02\00" "\01" ":  " "\36\00\00\00")
  (elem (i32.const 0x36) $:)
  ...
  (func $semicolon (param $tos i32) (result i32)
    ...
    (call $hidden)
    (call $left-bracket))
  (data (i32.const 0x20284) "\78\02\02\00" "\81" (; F_IMMEDIATE ;) ";  " "\37\00\00\00")
  (elem (i32.const 0x37) $semicolon)
  ...
  (func $<# (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2029c) "\90\02\02\00" "\02" "<# " "\39\00\00\00")
  (elem (i32.const 0x39) $<#)
  ...
  (func $= (param $tos i32) (result i32)
    ...
    (if (i32.eq (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x202a8) "\9c\02\02\00" "\01" "=  " "\3a\00\00\00")
  (elem (i32.const 0x3a) $=)
  ...
  (func $>BODY (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202c0) "\b4\02\02\00" "\05" ">BODY  " "\3c\00\00\00")
  (elem (i32.const 0x3c) $>BODY)

  ;; [6.1.0560](https://forth-standard.org/standard/core/toIN)
  (data (i32.const 0x202d0) "\c0\02\02\00" "\43" (; F_DATA ;) ">IN" "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00")
  ...
  (func $>NUMBER (param $tos i32) (result i32) 
    ...
    (local.get $tos))
  (data (i32.const 0x202e0) "\d0\02\02\00" "\07" ">NUMBER" "\3d\00\00\00")
  (elem (i32.const 0x3d) $>NUMBER)
  ...
  (data (i32.const 0x202f0) "\e0\02\02\00" "\02" ">R " "\3e\00\00\00")
  (elem (i32.const 0x3e) $>R)
  ...
  (func $?DUP (param $tos i32) (result i32)
    ...
    (if (result i32) (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else 
        (local.get $tos))))
  (data (i32.const 0x202fc) "\f0\02\02\00" "\04" "?DUP   " "\3f\00\00\00")
  (elem (i32.const 0x3f) $?DUP)
  ...
  (func $@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2030c) "\fc\02\02\00" "\01" "@  " "\40\00\00\00")
  (elem (i32.const 0x40) $@)
  ...
  (data (i32.const 0x20318) "\0c\03\02\00" "\05" "ABORT  " "\41\00\00\00")
  (elem (i32.const 0x41) $ABORT)
  ...
  (func $ABORTq (param $tos i32) (result i32)
    ...
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9b (; = index("TYPE") ;)))
    (call $emitICall (i32.const 0) (i32.const 0x41 (; = index("ABORT") ;)))
    (call $compileThen))
  (data (i32.const 0x20328) "\18\03\02\00" "\86" (; F_IMMEDIATE ;) "ABORT\22 " "\42\00\00\00")
  (elem (i32.const 0x42) $ABORTq)
  ...
  (func $ABS (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))
                (i32.sub (i32.xor (local.tee $v (i32.load (local.get $btos)))
                        ...
                        (local.get $y)))
    (local.get $tos))
  (data (i32.const 0x20338) "\28\03\02\00" "\03" "ABS" "\43\00\00\00")
  (elem (i32.const 0x43) $ABS)
  ...
  (func $ACCEPT (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20344) "\38\03\02\00" "\06" "ACCEPT " "\44\00\00\00")
  (elem (i32.const 0x44) $ACCEPT)
  ...
  (func $ALIGN (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20354) "\44\03\02\00" "\05" "ALIGN  " "\45\00\00\00")
  (elem (i32.const 0x45) $ALIGN)
  ...
  (func $ALIGNED (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20364) "\54\03\02\00" "\07" "ALIGNED" "\46\00\00\00")
  (elem (i32.const 0x46) $ALIGNED)
  ...
  (data (i32.const 0x20374) "\64\03\02\00" "\05" "ALLOT  " "\47\00\00\00")
  (elem (i32.const 0x47) $ALLOT)
  ...
  (func $AND (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.and (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20384) "\74\03\02\00" "\03" "AND" "\48\00\00\00")
  (elem (i32.const 0x48) $AND)

  ;; [6.1.0750](https://forth-standard.org/standard/core/BASE)
  (data (i32.const 0x20390) "\84\03\02\00" "\44" (; F_DATA ;) "BASE   " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\0a\00\00\00" (; = pack(10) ;))
  ...
  (func $BEGIN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileBegin))
  (data (i32.const 0x203a4) "\90\03\02\00" "\85" (; F_IMMEDIATE ;) "BEGIN  " "\49\00\00\00")
  (elem (i32.const 0x49) $BEGIN)

  ;; [6.1.0770](https://forth-standard.org/standard/core/BL)
  (func $BL (param $tos i32) (result i32)
    (call $push (local.get $tos) (i32.const 32)))
  (data (i32.const 0x203b4) "\a4\03\02\00" "\02" "BL " "\4a\00\00\00")
  (elem (i32.const 0x4a) $BL)
  ...
  (func $C! (param $tos i32) (result i32)
    ...
    (i32.store8 (i32.load (i32.sub (local.get $tos) (i32.const 4)))
                (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))))
    (local.get $bbtos))
  (data (i32.const 0x203c0) "\b4\03\02\00" "\02" "C! " "\4b\00\00\00")
  (elem (i32.const 0x4b) $C!)
  ...
  (data (i32.const 0x203d8) "\cc\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\4d\00\00\00")
  (elem (i32.const 0x4d) $Cq)
  ...
  (func $C@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203e4) "\d8\03\02\00" "\02" "C@ " "\4e\00\00\00")
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203f0) "\e4\03\02\00" "\05" "CELL+  " "\4f\00\00\00")
  (elem (i32.const 0x4f) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20400) "\f0\03\02\00" "\05" "CELLS  " "\50\00\00\00")
  (elem (i32.const 0x50) $CELLS)
  ...
  (func $CHAR (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20410) "\00\04\02\00" "\04" "CHAR   " "\51\00\00\00")
  (elem (i32.const 0x51) $CHAR)

  ;; [6.1.0897](https://forth-standard.org/standard/core/CHARPlus)
  (func $CHAR+ (param $tos i32) (result i32)
    (call $1+ (local.get $tos)))
  (data (i32.const 0x20420) "\10\04\02\00" "\05" "CHAR+  " "\52\00\00\00")
  (elem (i32.const 0x52) $CHAR+)

  ;; [6.1.0898](https://forth-standard.org/standard/core/CHARS)
  (func $CHARS (param $tos i32) (result i32)
    (local.get $tos))
  (data (i32.const 0x20430) "\20\04\02\00" "\05" "CHARS  " "\53\00\00\00")
  (elem (i32.const 0x53) $CHARS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20440) "\30\04\02\00" "\08" "CONSTANT   " "\54\00\00\00")
  (elem (i32.const 0x54) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20454) "\40\04\02\00" "\05" "COUNT  " "\55\00\00\00")
  (elem (i32.const 0x55) $COUNT)
  ...
  (data (i32.const 0x20464) "\54\04\02\00" "\02" "CR " "\56\00\00\00")
  (elem (i32.const 0x56) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20470) "\64\04\02\00" "\06" "CREATE " "\57\00\00\00")
  (elem (i32.const 0x57) $CREATE)

  ;; [6.1.1170](https://forth-standard.org/standard/core/DECIMAL)
  (func $DECIMAL (param $tos i32) (result i32)
    (i32.store (i32.const 0x203a0 (; = body(BASE) ;)) (i32.const 10))
    (local.get $tos))
  (data (i32.const 0x20480) "\70\04\02\00" "\07" "DECIMAL" "\58\00\00\00")
  (elem (i32.const 0x58) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20490) "\80\04\02\00" "\05" "DEPTH  " "\59\00\00\00")
  (elem (i32.const 0x59) $DEPTH)
  ...
  (data (i32.const 0x204a0) "\90\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\5a\00\00\00")
  (elem (i32.const 0x5a) $DO)
  ...
  (data (i32.const 0x204ac) "\a0\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\5b\00\00\00")
  (elem (i32.const 0x5b) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204bc) "\ac\04\02\00" "\04" "DROP   " "\5c\00\00\00")
  (elem (i32.const 0x5c) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204cc) "\bc\04\02\00" "\03" "DUP" "\5d\00\00\00")
  (elem (i32.const 0x5d) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204d8) "\cc\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\5e\00\00\00")
  (elem (i32.const 0x5e) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204e8) "\d8\04\02\00" "\04" "EMIT   " "\5f\00\00\00")
  (elem (i32.const 0x5f) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x204f8) "\e8\04\02\00" "\0c" "ENVIRONMENT?   " "\60\00\00\00")
  (elem (i32.const 0x60) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x20510) "\f8\04\02\00" "\05" "ERASE  " "\61\00\00\00")
  (elem (i32.const 0x61) $ERASE)
  ...
  (func $EVALUATE (param $tos i32) (result i32)
    ...
    (local.set $prevIn (i32.load (i32.const 0x202dc (; = body(>IN) ;))))
    ...
    (i32.store (i32.const 0x202dc (; = body(>IN) ;)) (i32.const 0))

    (call $interpret (local.get $bbtos))

    ;; Restore input state
    (global.set $sourceID (local.get $prevSourceID))
    (i32.store (i32.const 0x202dc (; = body(>IN) ;)) (local.get $prevIn))
    (global.set $inputBufferBase (local.get $prevInputBufferBase))
    (global.set $inputBufferSize (local.get $prevInputBufferSize)))
  (data (i32.const 0x20520) "\10\05\02\00" "\08" "EVALUATE   " "\62\00\00\00")
  (elem (i32.const 0x62) $EVALUATE)
  ...
  (data (i32.const 0x20534) "\20\05\02\00" "\07" "EXECUTE" "\63\00\00\00")
  (elem (i32.const 0x63) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20544) "\34\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\64\00\00\00")
  (elem (i32.const 0x64) $EXIT)
  ...
  (data (i32.const 0x20554) "\44\05\02\00" "\05" "FALSE  " "\65\00\00\00")
  (elem (i32.const 0x65) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20564) "\54\05\02\00" "\04" "FILL   " "\66\00\00\00")
  (elem (i32.const 0x66) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20574) "\64\05\02\00" "\04" "FIND   " "\67\00\00\00")
  (elem (i32.const 0x67) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20584) "\74\05\02\00" "\06" "FM/MOD " "\68\00\00\00")
  (elem (i32.const 0x68) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20594) "\84\05\02\00" "\04" "HERE   " "\69\00\00\00")
  (elem (i32.const 0x69) $HERE)

  ;; [6.2.1660](https://forth-standard.org/standard/core/HEX)
  (func $HEX (param $tos i32) (result i32)
    (i32.store (i32.const 0x203a0 (; = body(BASE) ;)) (i32.const 16))
    (local.get $tos))
  (data (i32.const 0x205a4) "\94\05\02\00" "\03" "HEX" "\6a\00\00\00")
  (elem (i32.const 0x6a) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x205b0) "\a4\05\02\00" "\04" "HOLD   " "\6b\00\00\00")
  (elem (i32.const 0x6b) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205c0) "\b0\05\02\00" "\01" "I  " "\6c\00\00\00")
  (elem (i32.const 0x6c) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205cc) "\c0\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\6d\00\00\00")
  (elem (i32.const 0x6d) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205d8) "\cc\05\02\00" "\09" "IMMEDIATE  " "\6e\00\00\00")
  (elem (i32.const 0x6e) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205ec) "\d8\05\02\00" "\06" "INVERT " "\6f\00\00\00")
  (elem (i32.const 0x6f) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205fc) "\ec\05\02\00" "\01" "J  " "\70\00\00\00")
  (elem (i32.const 0x70) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20608) "\fc\05\02\00" "\03" "KEY" "\71\00\00\00")
  (elem (i32.const 0x71) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20614) "\08\06\02\00" "\06" "LATEST " "\72\00\00\00")
  (elem (i32.const 0x72) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20624) "\14\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\73\00\00\00")
  (elem (i32.const 0x73) $LEAVE)
  ...
  (data (i32.const 0x20634) "\24\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\74\00\00\00")
  (elem (i32.const 0x74) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20644) "\34\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\75\00\00\00")
  (elem (i32.const 0x75) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20654) "\44\06\02\00" "\06" "LSHIFT " "\76\00\00\00")
  (elem (i32.const 0x76) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20664) "\54\06\02\00" "\02" "M* " "\77\00\00\00")
  (elem (i32.const 0x77) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20670) "\64\06\02\00" "\03" "MAX" "\78\00\00\00")
  (elem (i32.const 0x78) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x2067c) "\70\06\02\00" "\03" "MIN" "\79\00\00\00")
  (elem (i32.const 0x79) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20688) "\7c\06\02\00" "\03" "MOD" "\7a\00\00\00")
  (elem (i32.const 0x7a) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x20694) "\88\06\02\00" "\04" "MOVE   " "\7b\00\00\00")
  (elem (i32.const 0x7b) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206a4) "\94\06\02\00" "\06" "NEGATE " "\7c\00\00\00")
  (elem (i32.const 0x7c) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x206b4) "\a4\06\02\00" "\03" "NIP" "\7d\00\00\00")
  (elem (i32.const 0x7d) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x206c0) "\b4\06\02\00" "\02" "OR " "\7e\00\00\00")
  (elem (i32.const 0x7e) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206cc) "\c0\06\02\00" "\04" "OVER   " "\7f\00\00\00")
  (elem (i32.const 0x7f) $OVER)
  ...
  (data (i32.const 0x206dc) "\cc\06\02\00" "\03" "PAD" "\80\00\00\00")
  (elem (i32.const 0x80) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x206e8) "\dc\06\02\00" "\05" "PARSE  " "\81\00\00\00")
  (elem (i32.const 0x81) $PARSE)
  ...
  (data (i32.const 0x206f8) "\e8\06\02\00" "\0a" "PARSE-NAME " "\82\00\00\00")
  (elem (i32.const 0x82) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2070c) "\f8\06\02\00" "\04" "PICK   " "\83\00\00\00")
  (elem (i32.const 0x83) $PICK)
  ...
  (data (i32.const 0x2071c) "\0c\07\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\84\00\00\00")
  (elem (i32.const 0x84) $POSTPONE)
  ...
  (data (i32.const 0x20730) "\1c\07\02\00" "\04" "QUIT   " "\85\00\00\00")
  (elem (i32.const 0x85) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20740) "\30\07\02\00" "\02" "R> " "\86\00\00\00")
  (elem (i32.const 0x86) $R>)

  ;; [6.1.2070](https://forth-standard.org/standard/core/RFetch)
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2074c) "\40\07\02\00" "\02" "R@ " "\87\00\00\00")
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20758) "\4c\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\88\00\00\00")
  (elem (i32.const 0x88) $RECURSE)
  ...
  (data (i32.const 0x20768) "\58\07\02\00" "\06" "REFILL " "\89\00\00\00")
  (elem (i32.const 0x89) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x20778) "\68\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\8a\00\00\00")
  (elem (i32.const 0x8a) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20788) "\78\07\02\00" "\03" "ROT" "\8b\00\00\00")
  (elem (i32.const 0x8b) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20794) "\88\07\02\00" "\06" "RSHIFT " "\8c\00\00\00")
  (elem (i32.const 0x8c) $RSHIFT)
  ...
  (data (i32.const 0x207a4) "\94\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\8d\00\00\00")
  (elem (i32.const 0x8d) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207b0) "\a4\07\02\00" "\03" "S>D" "\8e\00\00\00")
  (elem (i32.const 0x8e) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x207bc) "\b0\07\02\00" "\05" "SCALL  " "\8f\00\00\00")
  (elem (i32.const 0x8f) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207cc) "\bc\07\02\00" "\04" "SIGN   " "\90\00\00\00")
  (elem (i32.const 0x90) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207dc) "\cc\07\02\00" "\06" "SM/REM " "\91\00\00\00")
  (elem (i32.const 0x91) $SM/REM)
  ...
  (data (i32.const 0x207ec) "\dc\07\02\00" "\06" "SOURCE " "\92\00\00\00")
  (elem (i32.const 0x92) $SOURCE)
  ...
  (data (i32.const 0x207fc) "\ec\07\02\00" "\09" "SOURCE-ID  " "\93\00\00\00")
  (elem (i32.const 0x93) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x20810) "\fc\07\02\00" "\05" "SPACE  " "\94\00\00\00")
  (elem (i32.const 0x94) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x20820) "\10\08\02\00" "\06" "SPACES " "\95\00\00\00")
  (elem (i32.const 0x95) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x20830) "\20\08\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20844) "\30\08\02\00" "\04" "SWAP   " "\96\00\00\00")
  (elem (i32.const 0x96) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20854) "\44\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\97\00\00\00")
  (elem (i32.const 0x97) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20864) "\54\08\02\00" "\02" "TO " "\98\00\00\00")
  ...
  (data (i32.const 0x20870) "\64\08\02\00" "\04" "TRUE   " "\99\00\00\00")
  (elem (i32.const 0x99) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x20880) "\70\08\02\00" "\04" "TUCK   " "\9a\00\00\00")
  (elem (i32.const 0x9a) $TUCK)
  ...
  (data (i32.const 0x20890) "\80\08\02\00" "\04" "TYPE   " "\9b\00\00\00")
  (elem (i32.const 0x9b) $TYPE)

  ;; [6.1.2320](https://forth-standard.org/standard/core/Ud)
  (func $U. (param $tos i32) (result i32)
    (local.get $tos)
    (call $U._ (call $pop) (i32.load (i32.const 0x203a0 (; = body(BASE) ;))))
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x208a0) "\90\08\02\00" "\02" "U. " "\9c\00\00\00")
  (elem (i32.const 0x9c) $U.)
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208ac) "\a0\08\02\00" "\02" "U< " "\9d\00\00\00")
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x208b8) "\ac\08\02\00" "\03" "UM*" "\9e\00\00\00")
  (elem (i32.const 0x9e) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x208c4) "\b8\08\02\00" "\06" "UM/MOD " "\9f\00\00\00")
  (elem (i32.const 0x9f) $UM/MOD)
  ...
  (data (i32.const 0x208d4) "\c4\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\a0\00\00\00")
  (elem (i32.const 0xa0) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x208e4) "\d4\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\a1\00\00\00")
  (elem (i32.const 0xa1) $UNTIL)
  ...
  (data (i32.const 0x208f4) "\e4\08\02\00" "\06" "UNUSED " "\a2\00\00\00")
  (elem (i32.const 0xa2) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x20904) "\f4\08\02\00" "\05" "VALUE  " "\54\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20914) "\04\09\02\00" "\08" "VARIABLE   " "\a3\00\00\00")
  (elem (i32.const 0xa3) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x20928) "\14\09\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a4\00\00\00")
  (elem (i32.const 0xa4) $WHILE)
  ...
  (data (i32.const 0x20938) "\28\09\02\00" "\04" "WORD   " "\a5\00\00\00")
  (elem (i32.const 0xa5) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20948) "\38\09\02\00" "\05" "WORDS  " "\a6\00\00\00")
  (elem (i32.const 0xa6) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20958) "\48\09\02\00" "\03" "XOR" "\a7\00\00\00")
  (elem (i32.const 0xa7) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x20840 (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20964) "\58\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\a8\00\00\00")
  (elem (i32.const 0xa8) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20970) "\64\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\a9\00\00\00")
  (elem (i32.const 0xa9) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x2097c) "\70\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\aa\00\00\00")
  (elem (i32.const 0xaa) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x2098c) "\7c\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\ab\00\00\00")
  (elem (i32.const 0xab) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x20840 (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x20998) "\8c\09\02\00" "\01" "]  " "\ac\00\00\00")
  (elem (i32.const 0xac) $right-bracket)
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then 
            ...
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              ...
              (then 
                (local.set $number)
                (if (i32.load (i32.const 0x20840 (; = body(STATE) ;)))
                  (then
          ...
          (else 
            ...
            (if (i32.and
                  (i32.load (i32.const 0x20840 (; = body(STATE) ;)))
  ...
  (func $number (param $value i64) (param $addr i32) (param $length i32) (result i64 i32 i32)
    ...
    (local.set $base (i32.load (i32.const 0x203a0 (; = body(BASE) ;))))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x20998))
  (global $here (mut i32) (i32.const 0x209a4))
  (global $nextTableIndex (mut i32) (i32.const 0xad))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x20840 (; = body(STATE) ;))))
  ...
  (func $parse (param $delim i32) (result i32 i32)
    ...
    (local.set $p 
      ...
      (i32.load (i32.const 0x202dc (; = body(>IN) ;))))))
    ...
    (i32.store (i32.const 0x202dc (; = body(>IN) ;)) 
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x20840 (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
