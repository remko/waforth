...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xa9 funcref)
  ...
  (func $# (param $tos i32) (result i32)
    ...
    (local $m i64)
    (local $npo i32)
    (local.set $base (i64.extend_i32_u (i32.load (i32.const 0x20370 (; = body(BASE) ;)))))
  ...
  (func $. (param $tos i32) (result i32)
    ...
    (call $U._ (local.get $v) (i32.load (i32.const 0x20370 (; = body(BASE) ;))))
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x97 (; = index("TYPE") ;))))
  ...
  (func $.S (param $tos i32) (result i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (call $U._ (i32.load (local.get $p)) (i32.load (i32.const 0x20370 (; = body(BASE) ;))))
        (call $shell_emit (i32.const 0x20))
  ...
  (func $0< (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2019c) "\8c\01\02\00" "\02" "0< " "\25\00\00\00")
  ...
  (data (i32.const 0x20208) "\fc\01\02\00" "\05" "2DROP  " "\2e\00\00\00")
  (elem (i32.const 0x2e) $2DROP)
  ...
  (data (i32.const 0x20218) "\08\02\02\00" "\04" "2DUP   " "\2f\00\00\00")
  (elem (i32.const 0x2f) $2DUP)
  ...
  (func $2OVER (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x20228) "\18\02\02\00" "\05" "2OVER  " "\30\00\00\00")
  (elem (i32.const 0x30) $2OVER)
  ...
  (func $2SWAP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 4))
                (local.get $x2))
    (local.get $tos))
  (data (i32.const 0x20238) "\28\02\02\00" "\05" "2SWAP  " "\31\00\00\00")
  (elem (i32.const 0x31) $2SWAP)
  ...
  (func $: (param $tos i32) (result i32)
    ...
    (call $right-bracket))
  (data (i32.const 0x20248) "\38\02\02\00" "\01" ":  " "\32\00\00\00")
  (elem (i32.const 0x32) $:)
  ...
  (func $semicolon (param $tos i32) (result i32)
    ...
    (call $hidden)
    (call $left-bracket))
  (data (i32.const 0x20254) "\48\02\02\00" "\81" (; F_IMMEDIATE ;) ";  " "\33\00\00\00")
  (elem (i32.const 0x33) $semicolon)
  ...
  (func $< (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20260) "\54\02\02\00" "\01" "<  " "\34\00\00\00")
  (elem (i32.const 0x34) $<)
  ...
  (func $<# (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2026c) "\60\02\02\00" "\02" "<# " "\35\00\00\00")
  (elem (i32.const 0x35) $<#)
  ...
  (func $> (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x20284) "\78\02\02\00" "\01" ">  " "\37\00\00\00")
  (elem (i32.const 0x37) $>)
  ...
  (func $>BODY (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20290) "\84\02\02\00" "\05" ">BODY  " "\38\00\00\00")
  (elem (i32.const 0x38) $>BODY)

  ;; [6.1.0560](https://forth-standard.org/standard/core/toIN)
  (data (i32.const 0x202a0) "\90\02\02\00" "\43" (; F_DATA ;) ">IN" "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00")
  ...
  (func $>NUMBER (param $tos i32) (result i32) 
    ...
    (local.get $tos))
  (data (i32.const 0x202b0) "\a0\02\02\00" "\07" ">NUMBER" "\39\00\00\00")
  (elem (i32.const 0x39) $>NUMBER)
  ...
  (data (i32.const 0x202c0) "\b0\02\02\00" "\02" ">R " "\3a\00\00\00")
  (elem (i32.const 0x3a) $>R)
  ...
  (func $?DUP (param $tos i32) (result i32)
    ...
    (if (result i32) (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else 
        (local.get $tos))))
  (data (i32.const 0x202cc) "\c0\02\02\00" "\04" "?DUP   " "\3b\00\00\00")
  (elem (i32.const 0x3b) $?DUP)
  ...
  (func $@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202dc) "\cc\02\02\00" "\01" "@  " "\3c\00\00\00")
  (elem (i32.const 0x3c) $@)
  ...
  (data (i32.const 0x202e8) "\dc\02\02\00" "\05" "ABORT  " "\3d\00\00\00")
  (elem (i32.const 0x3d) $ABORT)
  ...
  (func $ABORTq (param $tos i32) (result i32)
    ...
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x97 (; = index("TYPE") ;)))
    (call $emitICall (i32.const 0) (i32.const 0x3d (; = index("ABORT") ;)))
    (call $compileThen))
  (data (i32.const 0x202f8) "\e8\02\02\00" "\86" (; F_IMMEDIATE ;) "ABORT\22 " "\3e\00\00\00")
  (elem (i32.const 0x3e) $ABORTq)
  ...
  (func $ABS (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))
                (i32.sub (i32.xor (local.tee $v (i32.load (local.get $btos)))
                        ...
                        (local.get $y)))
    (local.get $tos))
  (data (i32.const 0x20308) "\f8\02\02\00" "\03" "ABS" "\3f\00\00\00")
  (elem (i32.const 0x3f) $ABS)
  ...
  (func $ACCEPT (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20314) "\08\03\02\00" "\06" "ACCEPT " "\40\00\00\00")
  (elem (i32.const 0x40) $ACCEPT)
  ...
  (func $ALIGN (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20324) "\14\03\02\00" "\05" "ALIGN  " "\41\00\00\00")
  (elem (i32.const 0x41) $ALIGN)
  ...
  (func $ALIGNED (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20334) "\24\03\02\00" "\07" "ALIGNED" "\42\00\00\00")
  (elem (i32.const 0x42) $ALIGNED)
  ...
  (data (i32.const 0x20344) "\34\03\02\00" "\05" "ALLOT  " "\43\00\00\00")
  (elem (i32.const 0x43) $ALLOT)
  ...
  (func $AND (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.and (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20354) "\44\03\02\00" "\03" "AND" "\44\00\00\00")
  (elem (i32.const 0x44) $AND)

  ;; [6.1.0750](https://forth-standard.org/standard/core/BASE)
  (data (i32.const 0x20360) "\54\03\02\00" "\44" (; F_DATA ;) "BASE   " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\0a\00\00\00" (; = pack(10) ;))
  ...
  (func $BEGIN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileBegin))
  (data (i32.const 0x20374) "\60\03\02\00" "\85" (; F_IMMEDIATE ;) "BEGIN  " "\45\00\00\00")
  (elem (i32.const 0x45) $BEGIN)

  ;; [6.1.0770](https://forth-standard.org/standard/core/BL)
  (func $BL (param $tos i32) (result i32)
    (call $push (local.get $tos) (i32.const 32)))
  (data (i32.const 0x20384) "\74\03\02\00" "\02" "BL " "\46\00\00\00")
  (elem (i32.const 0x46) $BL)
  ...
  (func $Cc (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2039c) "\90\03\02\00" "\02" "C, " "\48\00\00\00")
  (elem (i32.const 0x48) $Cc)
  ...
  (data (i32.const 0x203a8) "\9c\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\49\00\00\00")
  (elem (i32.const 0x49) $Cq)
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203c0) "\b4\03\02\00" "\05" "CELL+  " "\4b\00\00\00")
  (elem (i32.const 0x4b) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203d0) "\c0\03\02\00" "\05" "CELLS  " "\4c\00\00\00")
  (elem (i32.const 0x4c) $CELLS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20410) "\00\04\02\00" "\08" "CONSTANT   " "\50\00\00\00")
  (elem (i32.const 0x50) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20424) "\10\04\02\00" "\05" "COUNT  " "\51\00\00\00")
  (elem (i32.const 0x51) $COUNT)
  ...
  (data (i32.const 0x20434) "\24\04\02\00" "\02" "CR " "\52\00\00\00")
  (elem (i32.const 0x52) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20440) "\34\04\02\00" "\06" "CREATE " "\53\00\00\00")
  (elem (i32.const 0x53) $CREATE)

  ;; [6.1.1170](https://forth-standard.org/standard/core/DECIMAL)
  (func $DECIMAL (param $tos i32) (result i32)
    (i32.store (i32.const 0x20370 (; = body(BASE) ;)) (i32.const 10))
    (local.get $tos))
  (data (i32.const 0x20450) "\40\04\02\00" "\07" "DECIMAL" "\54\00\00\00")
  (elem (i32.const 0x54) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20460) "\50\04\02\00" "\05" "DEPTH  " "\55\00\00\00")
  (elem (i32.const 0x55) $DEPTH)
  ...
  (data (i32.const 0x20470) "\60\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\56\00\00\00")
  (elem (i32.const 0x56) $DO)
  ...
  (data (i32.const 0x2047c) "\70\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\57\00\00\00")
  (elem (i32.const 0x57) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2048c) "\7c\04\02\00" "\04" "DROP   " "\58\00\00\00")
  (elem (i32.const 0x58) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2049c) "\8c\04\02\00" "\03" "DUP" "\59\00\00\00")
  (elem (i32.const 0x59) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204a8) "\9c\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\5a\00\00\00")
  (elem (i32.const 0x5a) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204b8) "\a8\04\02\00" "\04" "EMIT   " "\5b\00\00\00")
  (elem (i32.const 0x5b) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x204c8) "\b8\04\02\00" "\0c" "ENVIRONMENT?   " "\5c\00\00\00")
  (elem (i32.const 0x5c) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x204e0) "\c8\04\02\00" "\05" "ERASE  " "\5d\00\00\00")
  (elem (i32.const 0x5d) $ERASE)
  ...
  (func $EVALUATE (param $tos i32) (result i32)
    ...
    (local.set $prevIn (i32.load (i32.const 0x202ac (; = body(>IN) ;))))
    ...
    (i32.store (i32.const 0x202ac (; = body(>IN) ;)) (i32.const 0))

    (call $interpret (local.get $bbtos))

    ;; Restore input state
    (global.set $sourceID (local.get $prevSourceID))
    (i32.store (i32.const 0x202ac (; = body(>IN) ;)) (local.get $prevIn))
    (global.set $inputBufferBase (local.get $prevInputBufferBase))
    (global.set $inputBufferSize (local.get $prevInputBufferSize)))
  (data (i32.const 0x204f0) "\e0\04\02\00" "\08" "EVALUATE   " "\5e\00\00\00")
  (elem (i32.const 0x5e) $EVALUATE)
  ...
  (data (i32.const 0x20504) "\f0\04\02\00" "\07" "EXECUTE" "\5f\00\00\00")
  (elem (i32.const 0x5f) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20514) "\04\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\60\00\00\00")
  (elem (i32.const 0x60) $EXIT)
  ...
  (data (i32.const 0x20524) "\14\05\02\00" "\05" "FALSE  " "\61\00\00\00")
  (elem (i32.const 0x61) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20534) "\24\05\02\00" "\04" "FILL   " "\62\00\00\00")
  (elem (i32.const 0x62) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20544) "\34\05\02\00" "\04" "FIND   " "\63\00\00\00")
  (elem (i32.const 0x63) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20554) "\44\05\02\00" "\06" "FM/MOD " "\64\00\00\00")
  (elem (i32.const 0x64) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20564) "\54\05\02\00" "\04" "HERE   " "\65\00\00\00")
  (elem (i32.const 0x65) $HERE)

  ;; [6.2.1660](https://forth-standard.org/standard/core/HEX)
  (func $HEX (param $tos i32) (result i32)
    (i32.store (i32.const 0x20370 (; = body(BASE) ;)) (i32.const 16))
    (local.get $tos))
  (data (i32.const 0x20574) "\64\05\02\00" "\03" "HEX" "\66\00\00\00")
  (elem (i32.const 0x66) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x20580) "\74\05\02\00" "\04" "HOLD   " "\67\00\00\00")
  (elem (i32.const 0x67) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20590) "\80\05\02\00" "\01" "I  " "\68\00\00\00")
  (elem (i32.const 0x68) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x2059c) "\90\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\69\00\00\00")
  (elem (i32.const 0x69) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205a8) "\9c\05\02\00" "\09" "IMMEDIATE  " "\6a\00\00\00")
  (elem (i32.const 0x6a) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205bc) "\a8\05\02\00" "\06" "INVERT " "\6b\00\00\00")
  (elem (i32.const 0x6b) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205cc) "\bc\05\02\00" "\01" "J  " "\6c\00\00\00")
  (elem (i32.const 0x6c) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205d8) "\cc\05\02\00" "\03" "KEY" "\6d\00\00\00")
  (elem (i32.const 0x6d) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205e4) "\d8\05\02\00" "\06" "LATEST " "\6e\00\00\00")
  (elem (i32.const 0x6e) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x205f4) "\e4\05\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\6f\00\00\00")
  (elem (i32.const 0x6f) $LEAVE)
  ...
  (data (i32.const 0x20604) "\f4\05\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\70\00\00\00")
  (elem (i32.const 0x70) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20614) "\04\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\71\00\00\00")
  (elem (i32.const 0x71) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20624) "\14\06\02\00" "\06" "LSHIFT " "\72\00\00\00")
  (elem (i32.const 0x72) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20634) "\24\06\02\00" "\02" "M* " "\73\00\00\00")
  (elem (i32.const 0x73) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20640) "\34\06\02\00" "\03" "MAX" "\74\00\00\00")
  (elem (i32.const 0x74) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x2064c) "\40\06\02\00" "\03" "MIN" "\75\00\00\00")
  (elem (i32.const 0x75) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20658) "\4c\06\02\00" "\03" "MOD" "\76\00\00\00")
  (elem (i32.const 0x76) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x20664) "\58\06\02\00" "\04" "MOVE   " "\77\00\00\00")
  (elem (i32.const 0x77) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20674) "\64\06\02\00" "\06" "NEGATE " "\78\00\00\00")
  (elem (i32.const 0x78) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x20684) "\74\06\02\00" "\03" "NIP" "\79\00\00\00")
  (elem (i32.const 0x79) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20690) "\84\06\02\00" "\02" "OR " "\7a\00\00\00")
  (elem (i32.const 0x7a) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2069c) "\90\06\02\00" "\04" "OVER   " "\7b\00\00\00")
  (elem (i32.const 0x7b) $OVER)
  ...
  (data (i32.const 0x206ac) "\9c\06\02\00" "\03" "PAD" "\7c\00\00\00")
  (elem (i32.const 0x7c) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x206b8) "\ac\06\02\00" "\05" "PARSE  " "\7d\00\00\00")
  (elem (i32.const 0x7d) $PARSE)
  ...
  (data (i32.const 0x206c8) "\b8\06\02\00" "\0a" "PARSE-NAME " "\7e\00\00\00")
  (elem (i32.const 0x7e) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206dc) "\c8\06\02\00" "\04" "PICK   " "\7f\00\00\00")
  (elem (i32.const 0x7f) $PICK)
  ...
  (data (i32.const 0x206ec) "\dc\06\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\80\00\00\00")
  (elem (i32.const 0x80) $POSTPONE)
  ...
  (data (i32.const 0x20700) "\ec\06\02\00" "\04" "QUIT   " "\81\00\00\00")
  (elem (i32.const 0x81) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20710) "\00\07\02\00" "\02" "R> " "\82\00\00\00")
  ...
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2071c) "\10\07\02\00" "\02" "R@ " "\83\00\00\00")
  (elem (i32.const 0x83) $R@)
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20728) "\1c\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\84\00\00\00")
  (elem (i32.const 0x84) $RECURSE)
  ...
  (data (i32.const 0x20738) "\28\07\02\00" "\06" "REFILL " "\85\00\00\00")
  (elem (i32.const 0x85) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x20748) "\38\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\86\00\00\00")
  (elem (i32.const 0x86) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20758) "\48\07\02\00" "\03" "ROT" "\87\00\00\00")
  (elem (i32.const 0x87) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20764) "\58\07\02\00" "\06" "RSHIFT " "\88\00\00\00")
  (elem (i32.const 0x88) $RSHIFT)
  ...
  (data (i32.const 0x20774) "\64\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\89\00\00\00")
  (elem (i32.const 0x89) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20780) "\74\07\02\00" "\03" "S>D" "\8a\00\00\00")
  (elem (i32.const 0x8a) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x2078c) "\80\07\02\00" "\05" "SCALL  " "\8b\00\00\00")
  (elem (i32.const 0x8b) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x2079c) "\8c\07\02\00" "\04" "SIGN   " "\8c\00\00\00")
  (elem (i32.const 0x8c) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207ac) "\9c\07\02\00" "\06" "SM/REM " "\8d\00\00\00")
  (elem (i32.const 0x8d) $SM/REM)
  ...
  (data (i32.const 0x207bc) "\ac\07\02\00" "\06" "SOURCE " "\8e\00\00\00")
  (elem (i32.const 0x8e) $SOURCE)
  ...
  (data (i32.const 0x207cc) "\bc\07\02\00" "\09" "SOURCE-ID  " "\8f\00\00\00")
  (elem (i32.const 0x8f) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x207e0) "\cc\07\02\00" "\05" "SPACE  " "\90\00\00\00")
  (elem (i32.const 0x90) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x207f0) "\e0\07\02\00" "\06" "SPACES " "\91\00\00\00")
  (elem (i32.const 0x91) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x20800) "\f0\07\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20814) "\00\08\02\00" "\04" "SWAP   " "\92\00\00\00")
  (elem (i32.const 0x92) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20824) "\14\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\93\00\00\00")
  (elem (i32.const 0x93) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20834) "\24\08\02\00" "\02" "TO " "\94\00\00\00")
  (elem (i32.const 0x94) $TO)
  ...
  (data (i32.const 0x20840) "\34\08\02\00" "\04" "TRUE   " "\95\00\00\00")
  (elem (i32.const 0x95) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x20850) "\40\08\02\00" "\04" "TUCK   " "\96\00\00\00")
  (elem (i32.const 0x96) $TUCK)
  ...
  (data (i32.const 0x20860) "\50\08\02\00" "\04" "TYPE   " "\97\00\00\00")
  (elem (i32.const 0x97) $TYPE)

  ;; [6.1.2320](https://forth-standard.org/standard/core/Ud)
  (func $U. (param $tos i32) (result i32)
    (local.get $tos)
    (call $U._ (call $pop) (i32.load (i32.const 0x20370 (; = body(BASE) ;))))
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x20870) "\60\08\02\00" "\02" "U. " "\98\00\00\00")
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x2087c) "\70\08\02\00" "\02" "U< " "\99\00\00\00")
  (elem (i32.const 0x99) $U<)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20888) "\7c\08\02\00" "\03" "UM*" "\9a\00\00\00")
  (elem (i32.const 0x9a) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20894) "\88\08\02\00" "\06" "UM/MOD " "\9b\00\00\00")
  (elem (i32.const 0x9b) $UM/MOD)
  ...
  (data (i32.const 0x208a4) "\94\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\9c\00\00\00")
  (elem (i32.const 0x9c) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x208b4) "\a4\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\9d\00\00\00")
  (elem (i32.const 0x9d) $UNTIL)
  ...
  (data (i32.const 0x208c4) "\b4\08\02\00" "\06" "UNUSED " "\9e\00\00\00")
  (elem (i32.const 0x9e) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x208d4) "\c4\08\02\00" "\05" "VALUE  " "\50\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x208e4) "\d4\08\02\00" "\08" "VARIABLE   " "\9f\00\00\00")
  (elem (i32.const 0x9f) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x208f8) "\e4\08\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a0\00\00\00")
  (elem (i32.const 0xa0) $WHILE)
  ...
  (data (i32.const 0x20908) "\f8\08\02\00" "\04" "WORD   " "\a1\00\00\00")
  (elem (i32.const 0xa1) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20918) "\08\09\02\00" "\05" "WORDS  " "\a2\00\00\00")
  (elem (i32.const 0xa2) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20928) "\18\09\02\00" "\03" "XOR" "\a3\00\00\00")
  (elem (i32.const 0xa3) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x20810 (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20934) "\28\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\a4\00\00\00")
  (elem (i32.const 0xa4) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20940) "\34\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\a5\00\00\00")
  (elem (i32.const 0xa5) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x2094c) "\40\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\a6\00\00\00")
  (elem (i32.const 0xa6) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x2095c) "\4c\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\a7\00\00\00")
  (elem (i32.const 0xa7) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x20810 (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x20968) "\5c\09\02\00" "\01" "]  " "\a8\00\00\00")
  (elem (i32.const 0xa8) $right-bracket)
      ...
      (loop $loop
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then ;; Not in the dictionary. Is it a number?
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              (then ;; It's a number. Are we compiling?
                (local.set $number)
                (if (i32.load (i32.const 0x20810 (; = body(STATE) ;)))
                  (then
          ...
          (else ;; Found the word. 
            ...
            (if
                (i32.or 
                  (i32.eqz (i32.load (i32.const 0x20810 (; = body(STATE) ;))))
  ...
  (func $number (param $value i64) (param $addr i32) (param $length i32) (result i64 i32 i32)
    ...
    (local.set $base (i32.load (i32.const 0x20370 (; = body(BASE) ;))))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x20968))
  (global $here (mut i32) (i32.const 0x20974))
  (global $nextTableIndex (mut i32) (i32.const 0xa9))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x20810 (; = body(STATE) ;))))
  ...
  (func $parse (param $delim i32) (result i32 i32)
    ...
    (local.set $p 
      ...
      (i32.load (i32.const 0x202ac (; = body(>IN) ;))))))
    ...
    (i32.store (i32.const 0x202ac (; = body(>IN) ;)) 
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x20810 (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
