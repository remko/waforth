...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xaa funcref)
  ...
  (func $# (param $tos i32) (result i32)
    ...
    (local $m i64)
    (local $npo i32)
    (local.set $base (i64.extend_i32_u (i32.load (i32.const 0x2037c (; = body(BASE) ;)))))
  ...
  (func $. (param $tos i32) (result i32)
    ...
    (call $U._ (local.get $v) (i32.load (i32.const 0x2037c (; = body(BASE) ;))))
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x98 (; = index("TYPE") ;))))
  ...
  (func $.S (param $tos i32) (result i32)
    ...
    (block $endLoop
      (loop $loop
        ...
        (call $U._ (i32.load (local.get $p)) (i32.load (i32.const 0x2037c (; = body(BASE) ;))))
        (call $shell_emit (i32.const 0x20))
  ...
  (data (i32.const 0x20214) "\08\02\02\00" "\05" "2DROP  " "\2f\00\00\00")
  (elem (i32.const 0x2f) $2DROP)
  ...
  (data (i32.const 0x20224) "\14\02\02\00" "\04" "2DUP   " "\30\00\00\00")
  (elem (i32.const 0x30) $2DUP)
  ...
  (func $2OVER (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 8)))
  (data (i32.const 0x20234) "\24\02\02\00" "\05" "2OVER  " "\31\00\00\00")
  (elem (i32.const 0x31) $2OVER)
  ...
  (func $2SWAP (param $tos i32) (result i32)
    ...
    (i32.store (i32.sub (local.get $tos) (i32.const 4))
                (local.get $x2))
    (local.get $tos))
  (data (i32.const 0x20244) "\34\02\02\00" "\05" "2SWAP  " "\32\00\00\00")
  (elem (i32.const 0x32) $2SWAP)
  ...
  (func $: (param $tos i32) (result i32)
    ...
    (call $right-bracket))
  (data (i32.const 0x20254) "\44\02\02\00" "\01" ":  " "\33\00\00\00")
  (elem (i32.const 0x33) $:)
  ...
  (func $semicolon (param $tos i32) (result i32)
    ...
    (call $hidden)
    (call $left-bracket))
  (data (i32.const 0x20260) "\54\02\02\00" "\81" (; F_IMMEDIATE ;) ";  " "\34\00\00\00")
  (elem (i32.const 0x34) $semicolon)
  ...
  (func $<# (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20278) "\6c\02\02\00" "\02" "<# " "\36\00\00\00")
  (elem (i32.const 0x36) $<#)
  ...
  (func $>BODY (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2029c) "\90\02\02\00" "\05" ">BODY  " "\39\00\00\00")
  (elem (i32.const 0x39) $>BODY)

  ;; [6.1.0560](https://forth-standard.org/standard/core/toIN)
  (data (i32.const 0x202ac) "\9c\02\02\00" "\43" (; F_DATA ;) ">IN" "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00")
  ...
  (func $>NUMBER (param $tos i32) (result i32) 
    ...
    (local.get $tos))
  (data (i32.const 0x202bc) "\ac\02\02\00" "\07" ">NUMBER" "\3a\00\00\00")
  (elem (i32.const 0x3a) $>NUMBER)
  ...
  (data (i32.const 0x202cc) "\bc\02\02\00" "\02" ">R " "\3b\00\00\00")
  (elem (i32.const 0x3b) $>R)
  ...
  (func $?DUP (param $tos i32) (result i32)
    ...
    (if (result i32) (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
      ...
      (else 
        (local.get $tos))))
  (data (i32.const 0x202d8) "\cc\02\02\00" "\04" "?DUP   " "\3c\00\00\00")
  (elem (i32.const 0x3c) $?DUP)
  ...
  (func $@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x202e8) "\d8\02\02\00" "\01" "@  " "\3d\00\00\00")
  (elem (i32.const 0x3d) $@)
  ...
  (data (i32.const 0x202f4) "\e8\02\02\00" "\05" "ABORT  " "\3e\00\00\00")
  (elem (i32.const 0x3e) $ABORT)
  ...
  (func $ABORTq (param $tos i32) (result i32)
    ...
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x98 (; = index("TYPE") ;)))
    (call $emitICall (i32.const 0) (i32.const 0x3e (; = index("ABORT") ;)))
    (call $compileThen))
  (data (i32.const 0x20304) "\f4\02\02\00" "\86" (; F_IMMEDIATE ;) "ABORT\22 " "\3f\00\00\00")
  (elem (i32.const 0x3f) $ABORTq)
  ...
  (func $ABS (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))
                (i32.sub (i32.xor (local.tee $v (i32.load (local.get $btos)))
                        ...
                        (local.get $y)))
    (local.get $tos))
  (data (i32.const 0x20314) "\04\03\02\00" "\03" "ABS" "\40\00\00\00")
  (elem (i32.const 0x40) $ABS)
  ...
  (func $ACCEPT (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20320) "\14\03\02\00" "\06" "ACCEPT " "\41\00\00\00")
  (elem (i32.const 0x41) $ACCEPT)
  ...
  (func $ALIGN (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20330) "\20\03\02\00" "\05" "ALIGN  " "\42\00\00\00")
  (elem (i32.const 0x42) $ALIGN)
  ...
  (func $ALIGNED (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20340) "\30\03\02\00" "\07" "ALIGNED" "\43\00\00\00")
  (elem (i32.const 0x43) $ALIGNED)
  ...
  (data (i32.const 0x20350) "\40\03\02\00" "\05" "ALLOT  " "\44\00\00\00")
  (elem (i32.const 0x44) $ALLOT)
  ...
  (func $AND (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.and (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20360) "\50\03\02\00" "\03" "AND" "\45\00\00\00")
  (elem (i32.const 0x45) $AND)

  ;; [6.1.0750](https://forth-standard.org/standard/core/BASE)
  (data (i32.const 0x2036c) "\60\03\02\00" "\44" (; F_DATA ;) "BASE   " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\0a\00\00\00" (; = pack(10) ;))
  ...
  (func $BEGIN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileBegin))
  (data (i32.const 0x20380) "\6c\03\02\00" "\85" (; F_IMMEDIATE ;) "BEGIN  " "\46\00\00\00")
  (elem (i32.const 0x46) $BEGIN)

  ;; [6.1.0770](https://forth-standard.org/standard/core/BL)
  (func $BL (param $tos i32) (result i32)
    (call $push (local.get $tos) (i32.const 32)))
  (data (i32.const 0x20390) "\80\03\02\00" "\02" "BL " "\47\00\00\00")
  (elem (i32.const 0x47) $BL)
  ...
  (data (i32.const 0x203b4) "\a8\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\4a\00\00\00")
  (elem (i32.const 0x4a) $Cq)
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203cc) "\c0\03\02\00" "\05" "CELL+  " "\4c\00\00\00")
  (elem (i32.const 0x4c) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x203dc) "\cc\03\02\00" "\05" "CELLS  " "\4d\00\00\00")
  (elem (i32.const 0x4d) $CELLS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x2041c) "\0c\04\02\00" "\08" "CONSTANT   " "\51\00\00\00")
  (elem (i32.const 0x51) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20430) "\1c\04\02\00" "\05" "COUNT  " "\52\00\00\00")
  (elem (i32.const 0x52) $COUNT)
  ...
  (data (i32.const 0x20440) "\30\04\02\00" "\02" "CR " "\53\00\00\00")
  (elem (i32.const 0x53) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2044c) "\40\04\02\00" "\06" "CREATE " "\54\00\00\00")
  (elem (i32.const 0x54) $CREATE)

  ;; [6.1.1170](https://forth-standard.org/standard/core/DECIMAL)
  (func $DECIMAL (param $tos i32) (result i32)
    (i32.store (i32.const 0x2037c (; = body(BASE) ;)) (i32.const 10))
    (local.get $tos))
  (data (i32.const 0x2045c) "\4c\04\02\00" "\07" "DECIMAL" "\55\00\00\00")
  (elem (i32.const 0x55) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2046c) "\5c\04\02\00" "\05" "DEPTH  " "\56\00\00\00")
  (elem (i32.const 0x56) $DEPTH)
  ...
  (data (i32.const 0x2047c) "\6c\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\57\00\00\00")
  (elem (i32.const 0x57) $DO)
  ...
  (data (i32.const 0x20488) "\7c\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\58\00\00\00")
  (elem (i32.const 0x58) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20498) "\88\04\02\00" "\04" "DROP   " "\59\00\00\00")
  (elem (i32.const 0x59) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204a8) "\98\04\02\00" "\03" "DUP" "\5a\00\00\00")
  (elem (i32.const 0x5a) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204b4) "\a8\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\5b\00\00\00")
  (elem (i32.const 0x5b) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204c4) "\b4\04\02\00" "\04" "EMIT   " "\5c\00\00\00")
  (elem (i32.const 0x5c) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x204d4) "\c4\04\02\00" "\0c" "ENVIRONMENT?   " "\5d\00\00\00")
  (elem (i32.const 0x5d) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x204ec) "\d4\04\02\00" "\05" "ERASE  " "\5e\00\00\00")
  (elem (i32.const 0x5e) $ERASE)
  ...
  (func $EVALUATE (param $tos i32) (result i32)
    ...
    (local.set $prevIn (i32.load (i32.const 0x202b8 (; = body(>IN) ;))))
    ...
    (i32.store (i32.const 0x202b8 (; = body(>IN) ;)) (i32.const 0))

    (call $interpret (local.get $bbtos))

    ;; Restore input state
    (global.set $sourceID (local.get $prevSourceID))
    (i32.store (i32.const 0x202b8 (; = body(>IN) ;)) (local.get $prevIn))
    (global.set $inputBufferBase (local.get $prevInputBufferBase))
    (global.set $inputBufferSize (local.get $prevInputBufferSize)))
  (data (i32.const 0x204fc) "\ec\04\02\00" "\08" "EVALUATE   " "\5f\00\00\00")
  (elem (i32.const 0x5f) $EVALUATE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20520) "\10\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\61\00\00\00")
  (elem (i32.const 0x61) $EXIT)
  ...
  (data (i32.const 0x20530) "\20\05\02\00" "\05" "FALSE  " "\62\00\00\00")
  (elem (i32.const 0x62) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20540) "\30\05\02\00" "\04" "FILL   " "\63\00\00\00")
  (elem (i32.const 0x63) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20550) "\40\05\02\00" "\04" "FIND   " "\64\00\00\00")
  (elem (i32.const 0x64) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x20560) "\50\05\02\00" "\06" "FM/MOD " "\65\00\00\00")
  (elem (i32.const 0x65) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20570) "\60\05\02\00" "\04" "HERE   " "\66\00\00\00")
  (elem (i32.const 0x66) $HERE)

  ;; [6.2.1660](https://forth-standard.org/standard/core/HEX)
  (func $HEX (param $tos i32) (result i32)
    (i32.store (i32.const 0x2037c (; = body(BASE) ;)) (i32.const 16))
    (local.get $tos))
  (data (i32.const 0x20580) "\70\05\02\00" "\03" "HEX" "\67\00\00\00")
  (elem (i32.const 0x67) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x2058c) "\80\05\02\00" "\04" "HOLD   " "\68\00\00\00")
  (elem (i32.const 0x68) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2059c) "\8c\05\02\00" "\01" "I  " "\69\00\00\00")
  (elem (i32.const 0x69) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205a8) "\9c\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\6a\00\00\00")
  (elem (i32.const 0x6a) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205b4) "\a8\05\02\00" "\09" "IMMEDIATE  " "\6b\00\00\00")
  (elem (i32.const 0x6b) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205c8) "\b4\05\02\00" "\06" "INVERT " "\6c\00\00\00")
  (elem (i32.const 0x6c) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205d8) "\c8\05\02\00" "\01" "J  " "\6d\00\00\00")
  (elem (i32.const 0x6d) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205e4) "\d8\05\02\00" "\03" "KEY" "\6e\00\00\00")
  (elem (i32.const 0x6e) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205f0) "\e4\05\02\00" "\06" "LATEST " "\6f\00\00\00")
  (elem (i32.const 0x6f) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20600) "\f0\05\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\70\00\00\00")
  (elem (i32.const 0x70) $LEAVE)
  ...
  (data (i32.const 0x20610) "\00\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\71\00\00\00")
  (elem (i32.const 0x71) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20620) "\10\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\72\00\00\00")
  (elem (i32.const 0x72) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20630) "\20\06\02\00" "\06" "LSHIFT " "\73\00\00\00")
  (elem (i32.const 0x73) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20640) "\30\06\02\00" "\02" "M* " "\74\00\00\00")
  (elem (i32.const 0x74) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x2064c) "\40\06\02\00" "\03" "MAX" "\75\00\00\00")
  (elem (i32.const 0x75) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x20658) "\4c\06\02\00" "\03" "MIN" "\76\00\00\00")
  (elem (i32.const 0x76) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20664) "\58\06\02\00" "\03" "MOD" "\77\00\00\00")
  (elem (i32.const 0x77) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x20670) "\64\06\02\00" "\04" "MOVE   " "\78\00\00\00")
  (elem (i32.const 0x78) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20680) "\70\06\02\00" "\06" "NEGATE " "\79\00\00\00")
  (elem (i32.const 0x79) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x20690) "\80\06\02\00" "\03" "NIP" "\7a\00\00\00")
  (elem (i32.const 0x7a) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x2069c) "\90\06\02\00" "\02" "OR " "\7b\00\00\00")
  (elem (i32.const 0x7b) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206a8) "\9c\06\02\00" "\04" "OVER   " "\7c\00\00\00")
  (elem (i32.const 0x7c) $OVER)
  ...
  (data (i32.const 0x206b8) "\a8\06\02\00" "\03" "PAD" "\7d\00\00\00")
  (elem (i32.const 0x7d) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x206c4) "\b8\06\02\00" "\05" "PARSE  " "\7e\00\00\00")
  (elem (i32.const 0x7e) $PARSE)
  ...
  (data (i32.const 0x206d4) "\c4\06\02\00" "\0a" "PARSE-NAME " "\7f\00\00\00")
  (elem (i32.const 0x7f) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206e8) "\d4\06\02\00" "\04" "PICK   " "\80\00\00\00")
  (elem (i32.const 0x80) $PICK)
  ...
  (data (i32.const 0x206f8) "\e8\06\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\81\00\00\00")
  (elem (i32.const 0x81) $POSTPONE)
  ...
  (data (i32.const 0x2070c) "\f8\06\02\00" "\04" "QUIT   " "\82\00\00\00")
  (elem (i32.const 0x82) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2071c) "\0c\07\02\00" "\02" "R> " "\83\00\00\00")
  ...
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20728) "\1c\07\02\00" "\02" "R@ " "\84\00\00\00")
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20734) "\28\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\85\00\00\00")
  (elem (i32.const 0x85) $RECURSE)
  ...
  (data (i32.const 0x20744) "\34\07\02\00" "\06" "REFILL " "\86\00\00\00")
  (elem (i32.const 0x86) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x20754) "\44\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\87\00\00\00")
  (elem (i32.const 0x87) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20764) "\54\07\02\00" "\03" "ROT" "\88\00\00\00")
  (elem (i32.const 0x88) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20770) "\64\07\02\00" "\06" "RSHIFT " "\89\00\00\00")
  (elem (i32.const 0x89) $RSHIFT)
  ...
  (data (i32.const 0x20780) "\70\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\8a\00\00\00")
  (elem (i32.const 0x8a) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2078c) "\80\07\02\00" "\03" "S>D" "\8b\00\00\00")
  (elem (i32.const 0x8b) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x20798) "\8c\07\02\00" "\05" "SCALL  " "\8c\00\00\00")
  (elem (i32.const 0x8c) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207a8) "\98\07\02\00" "\04" "SIGN   " "\8d\00\00\00")
  (elem (i32.const 0x8d) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207b8) "\a8\07\02\00" "\06" "SM/REM " "\8e\00\00\00")
  (elem (i32.const 0x8e) $SM/REM)
  ...
  (data (i32.const 0x207c8) "\b8\07\02\00" "\06" "SOURCE " "\8f\00\00\00")
  (elem (i32.const 0x8f) $SOURCE)
  ...
  (data (i32.const 0x207d8) "\c8\07\02\00" "\09" "SOURCE-ID  " "\90\00\00\00")
  (elem (i32.const 0x90) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x207ec) "\d8\07\02\00" "\05" "SPACE  " "\91\00\00\00")
  (elem (i32.const 0x91) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x207fc) "\ec\07\02\00" "\06" "SPACES " "\92\00\00\00")
  (elem (i32.const 0x92) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x2080c) "\fc\07\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20820) "\0c\08\02\00" "\04" "SWAP   " "\93\00\00\00")
  (elem (i32.const 0x93) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20830) "\20\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\94\00\00\00")
  (elem (i32.const 0x94) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20840) "\30\08\02\00" "\02" "TO " "\95\00\00\00")
  (elem (i32.const 0x95) $TO)
  ...
  (data (i32.const 0x2084c) "\40\08\02\00" "\04" "TRUE   " "\96\00\00\00")
  (elem (i32.const 0x96) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x2085c) "\4c\08\02\00" "\04" "TUCK   " "\97\00\00\00")
  (elem (i32.const 0x97) $TUCK)
  ...
  (data (i32.const 0x2086c) "\5c\08\02\00" "\04" "TYPE   " "\98\00\00\00")
  (elem (i32.const 0x98) $TYPE)

  ;; [6.1.2320](https://forth-standard.org/standard/core/Ud)
  (func $U. (param $tos i32) (result i32)
    (local.get $tos)
    (call $U._ (call $pop) (i32.load (i32.const 0x2037c (; = body(BASE) ;))))
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x2087c) "\6c\08\02\00" "\02" "U. " "\99\00\00\00")
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x20888) "\7c\08\02\00" "\02" "U< " "\9a\00\00\00")
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20894) "\88\08\02\00" "\03" "UM*" "\9b\00\00\00")
  (elem (i32.const 0x9b) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x208a0) "\94\08\02\00" "\06" "UM/MOD " "\9c\00\00\00")
  (elem (i32.const 0x9c) $UM/MOD)
  ...
  (data (i32.const 0x208b0) "\a0\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\9d\00\00\00")
  (elem (i32.const 0x9d) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x208c0) "\b0\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\9e\00\00\00")
  (elem (i32.const 0x9e) $UNTIL)
  ...
  (data (i32.const 0x208d0) "\c0\08\02\00" "\06" "UNUSED " "\9f\00\00\00")
  (elem (i32.const 0x9f) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x208e0) "\d0\08\02\00" "\05" "VALUE  " "\51\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x208f0) "\e0\08\02\00" "\08" "VARIABLE   " "\a0\00\00\00")
  (elem (i32.const 0xa0) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x20904) "\f0\08\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a1\00\00\00")
  (elem (i32.const 0xa1) $WHILE)
  ...
  (data (i32.const 0x20914) "\04\09\02\00" "\04" "WORD   " "\a2\00\00\00")
  (elem (i32.const 0xa2) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20924) "\14\09\02\00" "\05" "WORDS  " "\a3\00\00\00")
  (elem (i32.const 0xa3) $WORDS)
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20934) "\24\09\02\00" "\03" "XOR" "\a4\00\00\00")
  (elem (i32.const 0xa4) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x2081c (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20940) "\34\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\a5\00\00\00")
  (elem (i32.const 0xa5) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x2094c) "\40\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\a6\00\00\00")
  (elem (i32.const 0xa6) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20958) "\4c\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\a7\00\00\00")
  (elem (i32.const 0xa7) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x20968) "\58\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\a8\00\00\00")
  (elem (i32.const 0xa8) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x2081c (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x20974) "\68\09\02\00" "\01" "]  " "\a9\00\00\00")
  (elem (i32.const 0xa9) $right-bracket)
  ...
  (func $number (param $value i64) (param $addr i32) (param $length i32) (result i64 i32 i32)
    ...
    (local.set $base (i32.load (i32.const 0x2037c (; = body(BASE) ;))))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x20974))
  (global $here (mut i32) (i32.const 0x20980))
  (global $nextTableIndex (mut i32) (i32.const 0xaa))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x2081c (; = body(STATE) ;))))
  ...
  (func $parse (param $delim i32) (result i32 i32)
    ...
    (local.set $p 
      ...
      (i32.load (i32.const 0x202b8 (; = body(>IN) ;))))))
    ...
    (i32.store (i32.const 0x202b8 (; = body(>IN) ;)) 
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x2081c (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
