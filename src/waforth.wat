...
(module $WAForth
  ...
  ;;   END_DO_INDEX := 9
  (table (export "table") 0xaf funcref)
  ...
  (func $.q (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $Sq)
    (call $emitICall (i32.const 0) (i32.const 0x9d (; = index("TYPE") ;))))
  ...
  (func $C! (param $tos i32) (result i32)
    ...
    (i32.store8 (i32.load (i32.sub (local.get $tos) (i32.const 4)))
                (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))))
    (local.get $bbtos))
  (data (i32.const 0x203dc) "\d0\03\02\00" "\02" "C! " "\4d\00\00\00")
  ...
  (func $Cc (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x203e8) "\dc\03\02\00" "\02" "C, " "\4e\00\00\00")
  (elem (i32.const 0x4e) $Cc)
  ...
  (data (i32.const 0x203f4) "\e8\03\02\00" "\82" (; F_IMMEDIATE ;) "C\22 " "\4f\00\00\00")
  (elem (i32.const 0x4f) $Cq)
  ...
  (func $C@ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20400) "\f4\03\02\00" "\02" "C@ " "\50\00\00\00")
  ...
  (func $CELL+ (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2040c) "\00\04\02\00" "\05" "CELL+  " "\51\00\00\00")
  (elem (i32.const 0x51) $CELL+)
  ...
  (func $CELLS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2041c) "\0c\04\02\00" "\05" "CELLS  " "\52\00\00\00")
  (elem (i32.const 0x52) $CELLS)
  ...
  (func $CONSTANT (param $tos i32) (result i32)
    ...
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x2045c) "\4c\04\02\00" "\08" "CONSTANT   " "\56\00\00\00")
  (elem (i32.const 0x56) $CONSTANT)
  ...
  (func $COUNT (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20470) "\5c\04\02\00" "\05" "COUNT  " "\57\00\00\00")
  (elem (i32.const 0x57) $COUNT)
  ...
  (data (i32.const 0x20480) "\70\04\02\00" "\02" "CR " "\58\00\00\00")
  (elem (i32.const 0x58) $CR)
  ...
  (func $CREATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2048c) "\80\04\02\00" "\06" "CREATE " "\59\00\00\00")
  (elem (i32.const 0x59) $CREATE)
  ...
  (func $DECIMAL (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x2049c) "\8c\04\02\00" "\07" "DECIMAL" "\5a\00\00\00")
  (elem (i32.const 0x5a) $DECIMAL)
  ...
  (func $DEPTH (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204ac) "\9c\04\02\00" "\05" "DEPTH  " "\5b\00\00\00")
  (elem (i32.const 0x5b) $DEPTH)
  ...
  (data (i32.const 0x204bc) "\ac\04\02\00" "\82" (; F_IMMEDIATE ;) "DO " "\5c\00\00\00")
  (elem (i32.const 0x5c) $DO)
  ...
  (data (i32.const 0x204c8) "\bc\04\02\00" "\85" (; F_IMMEDIATE ;) "DOES>  " "\5d\00\00\00")
  (elem (i32.const 0x5d) $DOES>)

  ;; [6.1.1260](https://forth-standard.org/standard/core/DROP)
  (func $DROP (param $tos i32) (result i32)
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204d8) "\c8\04\02\00" "\04" "DROP   " "\5e\00\00\00")
  (elem (i32.const 0x5e) $DROP)
  ...
  (func $DUP (param $tos i32) (result i32)
    (i32.store (local.get $tos)
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x204e8) "\d8\04\02\00" "\03" "DUP" "\5f\00\00\00")
  (elem (i32.const 0x5f) $DUP)
  ...
  (func $ELSE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitElse))
  (data (i32.const 0x204f4) "\e8\04\02\00" "\84" (; F_IMMEDIATE ;) "ELSE   " "\60\00\00\00")
  (elem (i32.const 0x60) $ELSE)
  ...
  (func $EMIT (param $tos i32) (result i32)
    ...
    (i32.sub (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20504) "\f4\04\02\00" "\04" "EMIT   " "\61\00\00\00")
  (elem (i32.const 0x61) $EMIT)
      ...
      (else 
        (if (result i32) (call $stringEqual (local.get $addr) (local.get $len) (i32.const 0x20076 (; = str("/COUNTED-STRING") + 1 ;)) (i32.const 0xf (; = len("/COUNTED-STRING") ;)))
          ...
          (else
            ...
            (local.get $btos))))))
  (data (i32.const 0x20514) "\04\05\02\00" "\0c" "ENVIRONMENT?   " "\62\00\00\00")
  (elem (i32.const 0x62) $ENVIRONMENT?)
  ...
  (func $ERASE (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbtos))
  (data (i32.const 0x2052c) "\14\05\02\00" "\05" "ERASE  " "\63\00\00\00")
  (elem (i32.const 0x63) $ERASE)
  ...
  (data (i32.const 0x2053c) "\2c\05\02\00" "\08" "EVALUATE   " "\64\00\00\00")
  (elem (i32.const 0x64) $EVALUATE)
  ...
  (data (i32.const 0x20550) "\3c\05\02\00" "\07" "EXECUTE" "\65\00\00\00")
  (elem (i32.const 0x65) $EXECUTE)
  ...
  (func $EXIT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $emitReturn))
  (data (i32.const 0x20560) "\50\05\02\00" "\84" (; F_IMMEDIATE ;) "EXIT   " "\66\00\00\00")
  (elem (i32.const 0x66) $EXIT)
  ...
  (data (i32.const 0x20570) "\60\05\02\00" "\05" "FALSE  " "\67\00\00\00")
  (elem (i32.const 0x67) $FALSE)
  ...
  (func $FILL (param $tos i32) (result i32)
    ...
    (memory.fill 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (local.get $bbbtos))
  (data (i32.const 0x20580) "\70\05\02\00" "\04" "FILL   " "\68\00\00\00")
  (elem (i32.const 0x68) $FILL)
  ...
  (func $FIND (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20590) "\80\05\02\00" "\04" "FIND   " "\69\00\00\00")
  (elem (i32.const 0x69) $FIND)
  ...
  (func $FM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x205a0) "\90\05\02\00" "\06" "FM/MOD " "\6a\00\00\00")
  (elem (i32.const 0x6a) $FM/MOD)
  ...
  (func $HERE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205b0) "\a0\05\02\00" "\04" "HERE   " "\6b\00\00\00")
  (elem (i32.const 0x6b) $HERE)
  ...
  (func $HEX (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205c0) "\b0\05\02\00" "\03" "HEX" "\6c\00\00\00")
  (elem (i32.const 0x6c) $HEX)
  ...
  (func $HOLD (param $tos i32) (result i32)
    ...
    (global.set $po (local.get $npo))
    (local.get $btos))
  (data (i32.const 0x205cc) "\c0\05\02\00" "\04" "HOLD   " "\6d\00\00\00")
  (elem (i32.const 0x6d) $HOLD)
  ...
  (func $I (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x205dc) "\cc\05\02\00" "\01" "I  " "\6e\00\00\00")
  (elem (i32.const 0x6e) $I)
  ...
  (func $IF (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileIf))
  (data (i32.const 0x205e8) "\dc\05\02\00" "\82" (; F_IMMEDIATE ;) "IF " "\6f\00\00\00")
  (elem (i32.const 0x6f) $IF)
  ...
  (func $IMMEDIATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x205f4) "\e8\05\02\00" "\09" "IMMEDIATE  " "\70\00\00\00")
  (elem (i32.const 0x70) $IMMEDIATE)
  ...
  (func $INVERT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20608) "\f4\05\02\00" "\06" "INVERT " "\71\00\00\00")
  (elem (i32.const 0x71) $INVERT)
  ...
  (func $J (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20618) "\08\06\02\00" "\01" "J  " "\72\00\00\00")
  (elem (i32.const 0x72) $J)
  ...
  (func $KEY (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20624) "\18\06\02\00" "\03" "KEY" "\73\00\00\00")
  (elem (i32.const 0x73) $KEY)

  (func $LATEST (param $tos i32) (result i32)
    (i32.store (local.get $tos) (global.get $latest))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20630) "\24\06\02\00" "\06" "LATEST " "\74\00\00\00")
  (elem (i32.const 0x74) $LATEST)
  ...
  (func $LEAVE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLeave))
  (data (i32.const 0x20640) "\30\06\02\00" "\85" (; F_IMMEDIATE ;) "LEAVE  " "\75\00\00\00")
  (elem (i32.const 0x75) $LEAVE)
  ...
  (data (i32.const 0x20650) "\40\06\02\00" "\87" (; F_IMMEDIATE ;) "LITERAL" "\76\00\00\00")
  (elem (i32.const 0x76) $LITERAL)
  ...
  (func $LOOP (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileLoop))
  (data (i32.const 0x20660) "\50\06\02\00" "\84" (; F_IMMEDIATE ;) "LOOP   " "\77\00\00\00")
  (elem (i32.const 0x77) $LOOP)
  ...
  (func $LSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shl (i32.load (local.get $bbtos))
                        (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x20670) "\60\06\02\00" "\06" "LSHIFT " "\78\00\00\00")
  (elem (i32.const 0x78) $LSHIFT)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_s (i32.load (local.get $bbtos)))
                        (i64.extend_i32_s (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x20680) "\70\06\02\00" "\02" "M* " "\79\00\00\00")
  (elem (i32.const 0x79) $M*)
  ...
  (func $MAX (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x2068c) "\80\06\02\00" "\03" "MAX" "\7a\00\00\00")
  (elem (i32.const 0x7a) $MAX)
  ...
  (func $MIN (param $tos i32) (result i32)
    ...
    (if (i32.gt_s (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (then
        (i32.store (local.get $bbtos) (local.get $v))))
    (local.get $btos))
  (data (i32.const 0x20698) "\8c\06\02\00" "\03" "MIN" "\7b\00\00\00")
  (elem (i32.const 0x7b) $MIN)
  ...
  (func $MOD (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.rem_s (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x206a4) "\98\06\02\00" "\03" "MOD" "\7c\00\00\00")
  (elem (i32.const 0x7c) $MOD)
  ...
  (func $MOVE (param $tos i32) (result i32)
    ...
    (memory.copy 
      ...
      (i32.load (i32.sub (local.get $tos) (i32.const 4))))
    (local.get $bbbtos))
  (data (i32.const 0x206b0) "\a4\06\02\00" "\04" "MOVE   " "\7d\00\00\00")
  (elem (i32.const 0x7d) $MOVE)
  ...
  (func $NEGATE (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x206c0) "\b0\06\02\00" "\06" "NEGATE " "\7e\00\00\00")
  (elem (i32.const 0x7e) $NEGATE)

  ;; [6.2.1930](https://forth-standard.org/standard/core/NIP)
  (func $NIP (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $DROP))
  (data (i32.const 0x206d0) "\c0\06\02\00" "\03" "NIP" "\7f\00\00\00")
  (elem (i32.const 0x7f) $NIP)
  ...
  (func $OR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.or (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x206dc) "\d0\06\02\00" "\02" "OR " "\80\00\00\00")
  (elem (i32.const 0x80) $OR)
  ...
  (func $OVER (param $tos i32) (result i32)
    (i32.store (local.get $tos)
                (i32.load (i32.sub (local.get $tos) (i32.const 8))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x206e8) "\dc\06\02\00" "\04" "OVER   " "\81\00\00\00")
  (elem (i32.const 0x81) $OVER)
  ...
  (data (i32.const 0x206f8) "\e8\06\02\00" "\03" "PAD" "\82\00\00\00")
  (elem (i32.const 0x82) $PAD)
  ...
  (func $PARSE (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 0x4)))
  (data (i32.const 0x20704) "\f8\06\02\00" "\05" "PARSE  " "\83\00\00\00")
  (elem (i32.const 0x83) $PARSE)
  ...
  (data (i32.const 0x20714) "\04\07\02\00" "\0a" "PARSE-NAME " "\84\00\00\00")
  (elem (i32.const 0x84) $PARSE-NAME)
  ...
  (func $PICK (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20728) "\14\07\02\00" "\04" "PICK   " "\85\00\00\00")
  (elem (i32.const 0x85) $PICK)
  ...
  (data (i32.const 0x20738) "\28\07\02\00" "\88" (; F_IMMEDIATE ;) "POSTPONE   " "\86\00\00\00")
  (elem (i32.const 0x86) $POSTPONE)
  ...
  (data (i32.const 0x2074c) "\38\07\02\00" "\04" "QUIT   " "\87\00\00\00")
  (elem (i32.const 0x87) $QUIT)
  ...
  (func $R> (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x2075c) "\4c\07\02\00" "\02" "R> " "\88\00\00\00")
  ...
  (func $R@ (param $tos i32) (result i32)
    (i32.store (local.get $tos) (i32.load (i32.sub (global.get $tors) (i32.const 4))))
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x20768) "\5c\07\02\00" "\02" "R@ " "\89\00\00\00")
  (elem (i32.const 0x89) $R@)
  ...
  (func $RECURSE  (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRecurse))
  (data (i32.const 0x20774) "\68\07\02\00" "\87" (; F_IMMEDIATE ;) "RECURSE" "\8a\00\00\00")
  (elem (i32.const 0x8a) $RECURSE)
  ...
  (data (i32.const 0x20784) "\74\07\02\00" "\06" "REFILL " "\8b\00\00\00")
  (elem (i32.const 0x8b) $REFILL)
  ...
  (func $REPEAT (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileRepeat))
  (data (i32.const 0x20794) "\84\07\02\00" "\86" (; F_IMMEDIATE ;) "REPEAT " "\8c\00\00\00")
  (elem (i32.const 0x8c) $REPEAT)
  ...
  (func $ROT (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x207a4) "\94\07\02\00" "\03" "ROT" "\8d\00\00\00")
  (elem (i32.const 0x8d) $ROT)
  ...
  (func $RSHIFT (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.shr_u (i32.load (local.get $bbtos))
                          (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))))
    (local.get $btos))
  (data (i32.const 0x207b0) "\a4\07\02\00" "\06" "RSHIFT " "\8e\00\00\00")
  (elem (i32.const 0x8e) $RSHIFT)
  ...
  (data (i32.const 0x207c0) "\b0\07\02\00" "\82" (; F_IMMEDIATE ;) "S\22 " "\8f\00\00\00")
  (elem (i32.const 0x8f) $Sq)
  ...
  (func $S>D (param $tos i32) (result i32)
    ...
    (i32.add (local.get $tos) (i32.const 4)))
  (data (i32.const 0x207cc) "\c0\07\02\00" "\03" "S>D" "\90\00\00\00")
  (elem (i32.const 0x90) $S>D)

  (func $SCALL (param $tos i32) (result i32)
    (global.set $tos (local.get $tos))
    (call $shell_call)
    (global.get $tos))
  (data (i32.const 0x207d8) "\cc\07\02\00" "\05" "SCALL  " "\91\00\00\00")
  (elem (i32.const 0x91) $SCALL)
  ...
  (func $SIGN (param $tos i32) (result i32)
    ...
    (if (i32.lt_s (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))) (i32.const 0))
      (then 
        ...
        (global.set $po (local.get $npo))))
    (local.get $btos))
  (data (i32.const 0x207e8) "\d8\07\02\00" "\04" "SIGN   " "\92\00\00\00")
  (elem (i32.const 0x92) $SIGN)
  ...
  (func $SM/REM (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x207f8) "\e8\07\02\00" "\06" "SM/REM " "\93\00\00\00")
  (elem (i32.const 0x93) $SM/REM)
  ...
  (data (i32.const 0x20808) "\f8\07\02\00" "\06" "SOURCE " "\94\00\00\00")
  (elem (i32.const 0x94) $SOURCE)
  ...
  (data (i32.const 0x20818) "\08\08\02\00" "\09" "SOURCE-ID  " "\95\00\00\00")
  (elem (i32.const 0x95) $SOURCE-ID)

  ;; [6.1.2220](https://forth-standard.org/standard/core/SPACE)
  (func $SPACE (param $tos i32) (result i32)
    (local.get $tos)
    (call $BL) (call $EMIT))
  (data (i32.const 0x2082c) "\18\08\02\00" "\05" "SPACE  " "\96\00\00\00")
  (elem (i32.const 0x96) $SPACE)
  ...
  (func $SPACES (param $tos i32) (result i32)
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (br $loop))))
  (data (i32.const 0x2083c) "\2c\08\02\00" "\06" "SPACES " "\97\00\00\00")
  (elem (i32.const 0x97) $SPACES)

  ;; [6.1.2250](https://forth-standard.org/standard/core/STATE)
  (data (i32.const 0x2084c) "\3c\08\02\00" "\45" (; F_DATA ;) "STATE  " "\03\00\00\00" (; = pack(PUSH_DATA_ADDRESS_INDEX) ;) "\00\00\00\00" (; = pack(0) ;))
  ...
  (func $SWAP (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20860) "\4c\08\02\00" "\04" "SWAP   " "\98\00\00\00")
  (elem (i32.const 0x98) $SWAP)
  ...
  (func $THEN (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileThen))
  (data (i32.const 0x20870) "\60\08\02\00" "\84" (; F_IMMEDIATE ;) "THEN   " "\99\00\00\00")
  (elem (i32.const 0x99) $THEN)
  ...
  (func $TO (param $tos i32) (result i32)
    ...
    (i32.store (i32.add (call $body (local.get $xt)) (i32.const 4)) 
      (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4)))))
    (local.get $btos))
  (data (i32.const 0x20880) "\70\08\02\00" "\02" "TO " "\9a\00\00\00")
  (elem (i32.const 0x9a) $TO)
  ...
  (data (i32.const 0x2088c) "\80\08\02\00" "\04" "TRUE   " "\9b\00\00\00")
  (elem (i32.const 0x9b) $TRUE)

  ;; [6.2.2300](https://forth-standard.org/standard/core/TUCK)
  (func $TUCK (param $tos i32) (result i32)
    (local.get $tos)
    (call $SWAP) (call $OVER))
  (data (i32.const 0x2089c) "\8c\08\02\00" "\04" "TUCK   " "\9c\00\00\00")
  (elem (i32.const 0x9c) $TUCK)
  ...
  (data (i32.const 0x208ac) "\9c\08\02\00" "\04" "TYPE   " "\9d\00\00\00")
  (elem (i32.const 0x9d) $TYPE)
  ...
  (func $U. (param $tos i32) (result i32)
    ...
    (call $shell_emit (i32.const 0x20)))
  (data (i32.const 0x208bc) "\ac\08\02\00" "\02" "U. " "\9e\00\00\00")
  ...
  (func $U< (param $tos i32) (result i32)
    ...
    (if (i32.lt_u (i32.load (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8))))
      ...
      (else (i32.store (local.get $bbtos) (i32.const 0))))
    (local.get $btos))
  (data (i32.const 0x208c8) "\bc\08\02\00" "\02" "U< " "\9f\00\00\00")
  (elem (i32.const 0x9f) $U<)
    ...
    (i64.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i64.mul (i64.extend_i32_u (i32.load (local.get $bbtos)))
                        (i64.extend_i32_u (i32.load (i32.sub (local.get $tos) 
                                                              (i32.const 4))))))
    (local.get $tos))
  (data (i32.const 0x208d4) "\c8\08\02\00" "\03" "UM*" "\a0\00\00\00")
  (elem (i32.const 0xa0) $UM*)
  ...
  (func $UM/MOD (param $tos i32) (result i32)
    ...
    (local.get $btos))
  (data (i32.const 0x208e0) "\d4\08\02\00" "\06" "UM/MOD " "\a1\00\00\00")
  (elem (i32.const 0xa1) $UM/MOD)
  ...
  (data (i32.const 0x208f0) "\e0\08\02\00" "\86" (; F_IMMEDIATE ;) "UNLOOP " "\a2\00\00\00")
  (elem (i32.const 0xa2) $UNLOOP)
  ...
  (func $UNTIL (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileUntil))
  (data (i32.const 0x20900) "\f0\08\02\00" "\85" (; F_IMMEDIATE ;) "UNTIL  " "\a3\00\00\00")
  (elem (i32.const 0xa3) $UNTIL)
  ...
  (data (i32.const 0x20910) "\00\09\02\00" "\06" "UNUSED " "\a4\00\00\00")
  (elem (i32.const 0xa4) $UNUSED)

  ;; [6.2.2405](https://forth-standard.org/standard/core/VALUE)
  (data (i32.const 0x20920) "\10\09\02\00" "\05" "VALUE  " "\56\00\00\00" (; = pack(index("CONSTANT")) ;))
  ...
  (func $VARIABLE (param $tos i32) (result i32)
    ...
    (call $CREATE)
    (global.set $here (i32.add (global.get $here) (i32.const 4))))
  (data (i32.const 0x20930) "\20\09\02\00" "\08" "VARIABLE   " "\a5\00\00\00")
  (elem (i32.const 0xa5) $VARIABLE)
  ...
  (func $WHILE (param $tos i32) (result i32)
    ...
    (call $ensureCompiling)
    (call $compileWhile))
  (data (i32.const 0x20944) "\30\09\02\00" "\85" (; F_IMMEDIATE ;) "WHILE  " "\a6\00\00\00")
  (elem (i32.const 0xa6) $WHILE)
  ...
  (data (i32.const 0x20954) "\44\09\02\00" "\04" "WORD   " "\a7\00\00\00")
  (elem (i32.const 0xa7) $WORD)
  ...
  (func $WORDS (param $tos i32) (result i32)
    ...
    (local.get $tos))
  (data (i32.const 0x20964) "\54\09\02\00" "\05" "WORDS  " "\a8\00\00\00")
  ...
  (func $XOR (param $tos i32) (result i32)
    ...
    (i32.store (local.tee $bbtos (i32.sub (local.get $tos) (i32.const 8)))
                (i32.xor (i32.load (local.tee $btos (i32.sub (local.get $tos) (i32.const 4))))
                        (i32.load (local.get $bbtos))))
    (local.get $btos))
  (data (i32.const 0x20974) "\64\09\02\00" "\03" "XOR" "\a9\00\00\00")
  (elem (i32.const 0xa9) $XOR)

  ;; [6.1.2500](https://forth-standard.org/standard/core/Bracket)
  (func $left-bracket (param $tos i32) (result i32)
    (local.get $tos)
    (call $ensureCompiling)
    (i32.store (i32.const 0x2085c (; = body(STATE) ;)) (i32.const 0)))
  (data (i32.const 0x20980) "\74\09\02\00" "\81" (; F_IMMEDIATE ;) "[  " "\aa\00\00\00")
  (elem (i32.const 0xaa) $left-bracket)
  ...
  (func $bracket-tick (param $tos i32) (result i32)
    ...
    (call $')
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x2098c) "\80\09\02\00" "\83" (; F_IMMEDIATE ;) "[']" "\ab\00\00\00")
  (elem (i32.const 0xab) $bracket-tick)
  ...
  (func $bracket-char (param $tos i32) (result i32)
    ...
    (call $CHAR)
    (call $compilePushConst (call $pop)))
  (data (i32.const 0x20998) "\8c\09\02\00" "\86" (; F_IMMEDIATE ;) "[CHAR] " "\ac\00\00\00")
  (elem (i32.const 0xac) $bracket-char)

  ;; [6.2.2535](https://forth-standard.org/standard/core/bs)
  (func $\ (param $tos i32) (result i32)
    (drop (drop (call $parse (i32.const 0x0a (; '\n' ;)))))
    (local.get $tos))
  (data (i32.const 0x209a8) "\98\09\02\00" "\81" (; F_IMMEDIATE ;) "\5c  " "\ad\00\00\00")
  (elem (i32.const 0xad) $\)

  ;; [6.1.2540](https://forth-standard.org/standard/right-bracket)
  (func $right-bracket (param $tos i32) (result i32)
    (i32.store (i32.const 0x2085c (; = body(STATE) ;)) (i32.const 1))
    (local.get $tos))
  (data (i32.const 0x209b4) "\a8\09\02\00" "\01" "]  " "\ae\00\00\00")
  (elem (i32.const 0xae) $right-bracket)
        ...
        (if (i32.eqz (local.get $FINDResult))
          (then 
            ...
            (if (param i32) (i32.eqz (call $readNumber (local.get $wordAddr) (local.get $wordLen)))
              ...
              (then 
                (local.set $number)
                (if (i32.load (i32.const 0x2085c (; = body(STATE) ;)))
                  (then
          ...
          (else 
            ...
            (if (i32.and
                  (i32.load (i32.const 0x2085c (; = body(STATE) ;)))
  ...
  ;; Dictionary pointers
  (global $latest (mut i32) (i32.const 0x209b4))
  (global $here (mut i32) (i32.const 0x209c0))
  (global $nextTableIndex (mut i32) (i32.const 0xaf))
  ...
  (func $ensureCompiling (param $tos i32) (result i32)
    (local.get $tos) 
    (if (param i32) (result i32) (i32.eqz (i32.load (i32.const 0x2085c (; = body(STATE) ;))))
    ...
    (block $endLoop (param i32) (result i32)
      (loop $loop (param i32) (result i32)
        ...
        (if (i32.eqz (local.get $silent))
          (then
            (if (i32.ge_s (i32.load (i32.const 0x2085c (; = body(STATE) ;))) (i32.const 0))
              (then
                ;; Write ok
